...
var SavePasswordPage = /** @class */ (function () {
    ...
    function SavePasswordPage(errorHandlingService, storageService, alertCtrl, uiService, toastrService, navParams, loadingController, fb, navCtrl, registerService) {
        ...
        this.ChangePasswordForm = this.fb.group({
            ...
            New: ['', [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["h" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["h" /* Validators */].minLength(4)]],
...
var BankBranchesPage = /** @class */ (function () {
    ...
    BankBranchesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-bank-branches',template:/*ion-inline-start:"E:\EshaWebTechnologies\VSCode Projects\Ionic-Angular-WebAPI Projects\SahakariApp\FrontEndNewUpdates\sahakariupdate\src\pages\bank-branches\bank-branches.html"*/'<!--\n\n  Generated template for the BankBranchesPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n  <ion-navbar color="primary">\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>Bank Branches</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <div *ngFor="let order of bankBranch" style="background-color:#ddd;border: 1px solid lightgrey; padding: 15px; margin: 5px 0;">\n\n    <span>Name: {{order.Name}}</span> \n\n    <br/>\n\n    <span>Mail Name:{{order.MailName}}</span> \n\n    <br/>\n\n    <span>Mobile No:{{order.MobileNo}}</span> \n\n</div> \n\n</ion-content>\n\n'/*ion-inline-end:"E:\EshaWebTechnologies\VSCode Projects\Ionic-Angular-WebAPI Projects\SahakariApp\FrontEndNewUpdates\sahakariupdate\src\pages\bank-branches\bank-branches.html"*/,
        }),
...
var ModalPage = /** @class */ (function () {
    ...
    ModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-modal',template:/*ion-inline-start:"E:\EshaWebTechnologies\VSCode Projects\Ionic-Angular-WebAPI Projects\SahakariApp\FrontEndNewUpdates\sahakariupdate\src\pages\modal\modal.html"*/'<ion-header>\n\n\n\n  <ion-navbar color="primary">\n\n    <ion-buttons start>\n\n      <!-- <button ion-button (click)="dismiss()">Close</button> -->\n\n\n\n      <button (click)="dismiss()">\n\n        <ion-icon name="close-circle" style="zoom:2.0;" item-right></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n    <ion-title>Reversed Voucher Detail</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <ion-card [hidden]="!myParam">\n\n    <ion-card-content>\n\n    <p ion-text color=\'danger\'>Reversal Transaction ID: {{VendorExtCode}}</p>\n\n    <p ion-text color=\'danger\'>Amount: {{Amount|currency:\'INR\'}}</p>\n\n    <p ion-text color=\'danger\'>Date: {{Date|date:\'dd/MM/yyyy\'}}</p>\n\n    <p ion-text color=\'danger\'>Remarks: {{Remarks}}</p>\n\n  </ion-card-content>\n\n  </ion-card>\n\n  <div [hidden]="myParam">\n\n    <p>No parameters passed.</p>\n\n  </div>\n\n  <!-- <button ion-button color="danger" (click)="dismiss()">Close</button> -->\n\n\n\n</ion-content>'/*ion-inline-end:"E:\EshaWebTechnologies\VSCode Projects\Ionic-Angular-WebAPI Projects\SahakariApp\FrontEndNewUpdates\sahakariupdate\src\pages\modal\modal.html"*/,
        }),
...
var PrepaidConfirmPage = /** @class */ (function () {
    ...
    PrepaidConfirmPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-prepaid-confirm',template:/*ion-inline-start:"E:\EshaWebTechnologies\VSCode Projects\Ionic-Angular-WebAPI Projects\SahakariApp\FrontEndNewUpdates\sahakariupdate\src\pages\prepaid-confirm\prepaid-confirm.html"*/'<!--\n\n  Generated template for the PrepaidConfirmPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n  <ion-navbar color="primary">\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title *ngIf="showTitle">\n\n      Confirm {{OperatorService}} Recharge-{{ActiveBankName}}\n\n    </ion-title>\n\n    <ion-title *ngIf="showSuccess||showPending||showInit||showFailure||showRefund||showBlocked">\n\n        <!-- <ion-title *ngIf="showSuccess"> -->\n\n      {{OperatorService}} Recharge -{{ActiveBankName}}\n\n    </ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <div class="row" *ngIf="showTitle">\n\n    <div class="col s12 m7">\n\n      <div class="card">\n\n          <!--interpolation-->\n\n        <div class="card-content">     \n\n        <span>Selected Operator : {{ operator }}</span> <br>\n\n        <span>Mobile No : {{ SubscriptionId }}</span> <br>\n\n        <span>Recharge Amount : {{ Amount }}</span> <br>\n\n        </div>       \n\n      </div>\n\n    </div>\n\n    <button id="register-button8" ion-button color="positive" type="button" (click)="OnConfirm()" block>\n\n      Confirm\n\n    </button>\n\n  </div>\n\n</ion-content>\n\n'/*ion-inline-end:"E:\EshaWebTechnologies\VSCode Projects\Ionic-Angular-WebAPI Projects\SahakariApp\FrontEndNewUpdates\sahakariupdate\src\pages\prepaid-confirm\prepaid-confirm.html"*/,
        }),
...
var SettingPage = /** @class */ (function () {
    ...
    SettingPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-setting',template:/*ion-inline-start:"E:\EshaWebTechnologies\VSCode Projects\Ionic-Angular-WebAPI Projects\SahakariApp\FrontEndNewUpdates\sahakariupdate\src\pages\setting\setting.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>\n\n      Settings\n\n    </ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding id="page2">\n\n<!-- \n\n  <ion-item>\n\n    <button ion-button (click)="changeLanguage(\'ka\')" >{{ \'demo.kannada\'| translate }}</button>\n\n    <button ion-button (click)="changeLanguage(\'en\')">{{ \'demo.english\'| translate }}</button>\n\n  </ion-item> -->\n\n  <ion-list radio-group>\n\n      <ion-list-header>\n\n        Select Language\n\n      </ion-list-header>\n\n  \n\n      <ion-item>\n\n        <ion-label>{{ \'demo.kannada\'| translate }}</ion-label>\n\n        <ion-radio (ionSelect)="changeLanguage(\'ka\')" checked="{{isKannada}}"></ion-radio>\n\n      </ion-item>\n\n  \n\n      <ion-item>\n\n          <ion-label>{{ \'demo.english\'| translate }}</ion-label>\n\n          <ion-radio (ionSelect)="changeLanguage(\'en\')" checked="{{isEnglish}}"></ion-radio>\n\n        </ion-item>\n\n      </ion-list>\n\n</ion-content>'/*ion-inline-end:"E:\EshaWebTechnologies\VSCode Projects\Ionic-Angular-WebAPI Projects\SahakariApp\FrontEndNewUpdates\sahakariupdate\src\pages\setting\setting.html"*/
        }),
...
var ContactUsPage = /** @class */ (function () {
    ...
    ContactUsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-contact-us',template:/*ion-inline-start:"E:\EshaWebTechnologies\VSCode Projects\Ionic-Angular-WebAPI Projects\SahakariApp\FrontEndNewUpdates\sahakariupdate\src\pages\contact-us\contact-us.html"*/'<!--\n  Generated template for the ContactUsPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color=\'primary\'>\n      <button ion-button menuToggle>\n          <ion-icon name="menu"></ion-icon>\n        </button>\n    <ion-title>Contact Us</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <ion-card>\n    <ion-item>\n<h2 style="color:blueviolet">For Any Technical queries, Contact at below Mail Address</h2>\n    <a style="color:crimson" href="mailto:support@aisplanet.com">support@aisplanet.com</a>\n</ion-item>\n  </ion-card>\n</ion-content>'/*ion-inline-end:"E:\EshaWebTechnologies\VSCode Projects\Ionic-Angular-WebAPI Projects\SahakariApp\FrontEndNewUpdates\sahakariupdate\src\pages\contact-us\contact-us.html"*/,
        }),
...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"E:\EshaWebTechnologies\VSCode Projects\Ionic-Angular-WebAPI Projects\SahakariApp\FrontEndNewUpdates\sahakariupdate\src\pages\home\home.html"*/'<div class="row" *ngIf="tenantlist">\n\n  <div class="col s12 m7">\n\n    <div class="card">\n\n        <!--interpolation-->\n\n      <div class="card-content">     \n\n           <div *ngFor="let order of tenantlist" style="border: 1px solid lightgrey; padding: 15px; margin: 5px 0;">\n\n      <span> Id : {{ order.Id |json }}</span> <br>\n\n      <span>Name : {{ order.Name | json }}</span> <br>\n\n      <span>Address : {{ order.Address }}</span> <br>\n\n\n\n    </div> \n\n\n\n      </div>       \n\n    </div>\n\n  </div>\n\n</div>\n\n'/*ion-inline-end:"E:\EshaWebTechnologies\VSCode Projects\Ionic-Angular-WebAPI Projects\SahakariApp\FrontEndNewUpdates\sahakariupdate\src\pages\home\home.html"*/
        }),
