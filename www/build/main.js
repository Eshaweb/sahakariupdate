...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mobile_recharge_mobile_recharge__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_Storage_Service__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__recharge_recharge__ = __webpack_require__(176);
...
var FavouritesPage = /** @class */ (function () {
    function FavouritesPage(storageService, loadingController, navCtrl, navParams) {
    ...
    FavouritesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-favourites',template:/*ion-inline-start:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\favourites\favourites.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>\n\n      New {{title}}\n\n    </ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n\n  <ion-list>\n\n      <ion-item color="assertive" id="favourites-list-item28" (click)="OnNewRecharge()">\n\n          <h2>New {{title}}</h2>\n\n        </ion-item>\n\n        <div class="row" *ngIf="favourites">\n\n          <ion-item *ngFor="let order of favourites">\n\n    <button ion-item  (click)="OnNickName(order)">\n\n      {{ order.NickName }}\n\n    </button>\n\n    <button ion-button  item-end (click)="OnDelete(order)">Delete</button>\n\n    <!-- <button ion-button color="danger" icon-start (click)="OnSubmit(order)">\n\n      <ion-icon name=\'close\'></ion-icon>\n\n      Remove\n\n    </button> -->\n\n  </ion-item>\n\n  </div>\n\n  </ion-list>\n\n</ion-content>\n\n<ion-footer>\n\n  <ion-toolbar color="primary">\n\n    <ion-title>{{ActiveBankName}} All Rights Rserved</ion-title>\n\n  </ion-toolbar>\n\n</ion-footer>'/*ion-inline-end:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\favourites\favourites.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_Storage_Service__["a" /* StorageService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */]])
    ], FavouritesPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_app_data_service__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ngx_toastr__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_UIService__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__change_bank_change_bank__ = __webpack_require__(178);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__banking_banking__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__fund_transfer_confirm_fund_transfer_confirm__ = __webpack_require__(383);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__services_ErrorHandlingService__ = __webpack_require__(49);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FundTransferPage = /** @class */ (function () {
    ...
    function FundTransferPage(errorHandlingService, navParams, storageService, alertCtrl, uiService, toastr, loadingController, registerService, formbuilder, navCtrl) {
        var _this = this;
        ...
        this.formgroup1 = formbuilder.group({
            MobileNo: ['', [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["h" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["h" /* Validators */].minLength(10)]]
        }); //builds the formgroup with the same formcontrolname.
        var MobileNoControl = this.formgroup1.get('MobileNo');
        MobileNoControl.valueChanges.subscribe(function (value) { return _this.setErrorMessage(MobileNoControl); });
    ...
    FundTransferPage.prototype.setErrorMessage = function (c) {
        var _this = this;
        var control = this.uiService.getControlName(c); //gives the control name property from particular service.
        document.getElementById('err_' + control).innerHTML = ''; //To not display the error message, if there is no error.
        if ((c.touched || c.dirty) && c.errors) {
            document.getElementById('err_' + control).innerHTML = Object.keys(c.errors).map(function (key) { return _this.validationMessages[control + '_' + key]; }).join(' ');
        }
    };
    ...
    FundTransferPage.prototype.ionViewDidLoad = function () {
        this.setBackButtonAction();
    };
    FundTransferPage.prototype.setBackButtonAction = function () {
        var _this = this;
        this.navBar.backButtonClick = function () {
            _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_8__banking_banking__["a" /* BankingPage */]);
        };
    };
    ...
    FundTransferPage.prototype.OnChangeBank = function () {
        ...
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_7__change_bank_change_bank__["a" /* ChangeBankPage */], { 'isFromFundTransfer': isFromFundTransfer }).then(function () {
            ...
            _this.navCtrl.remove(startIndex, 1); //removes the history of this page.
        });
    };
    FundTransferPage.prototype.OnSearchingAccount = function () {
        ...
        this.registerService.GetFTAccount(fundTransferRequest).subscribe(function (data) {
            ...
            if (error == 401) {
                _this.registerService.SetRefreshTokenNeeded();
                _this.registerService.GetToken(__WEBPACK_IMPORTED_MODULE_2__services_Storage_Service__["a" /* StorageService */].GetItem('refreshToken')).subscribe(function (data) {
                    __WEBPACK_IMPORTED_MODULE_2__services_Storage_Service__["a" /* StorageService */].SetItem('refreshToken', data.RefreshToken);
                    _this.registerService.SetToken(data.AccessToken);
                    _this.registerService.SetRefreshTokenNeeded();
                    _this.registerService.GetFTAccount(fundTransferRequest).subscribe(function (data) {
                        console.clear();
                        _this.fundTransferResponse = data;
                        _this.ToName = _this.fundTransferResponse.Name;
                        _this.ToAcNo = _this.fundTransferResponse.AcNo;
                ...
                _this.fundTransferResponse = null;
                if (typeof error === 'string') {
                    ...
                    _this.errorHandlingService.ErrorHandler(controls, ErrorProperties);
                    loading.dismiss();
                }
            }
        });
    };
    FundTransferPage.prototype.OnMobileNo = function (event) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SavePasswordPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_Storage_Service__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_UIService__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ngx_toastr__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_app_data_service__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__login_login__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__services_ErrorHandlingService__ = __webpack_require__(49);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 */
var SavePasswordPage = /** @class */ (function () {
    //oldPasswordMessage: string;
    function SavePasswordPage(errorHandlingService, storageService, alertCtrl, uiService, toastrService, navParams, loadingController, fb, navCtrl, registerService) {
        var _this = this;
        this.errorHandlingService = errorHandlingService;
        this.storageService = storageService;
        this.alertCtrl = alertCtrl;
        ...
        this.SavePasswordForm = this.fb.group({
            ...
            confirmpwd: ['', [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["h" /* Validators */].required]]
        ...
        PasswordControl.valueChanges.subscribe(function (value) { return _this.setErrorMessageForPasswordField(PasswordControl); }); //call the particular method if value changes in the control.
        var confirmpasswordControl = this.SavePasswordForm.get('confirmpwd');
        confirmpasswordControl.valueChanges.subscribe(function (value) { return _this.setErrorMessageForPasswordField(confirmpasswordControl); }); //call the particular method if value changes in the control.
        this.ChangePasswordForm = this.fb.group({
            Old: ['', [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["h" /* Validators */].required]],
            New: ['', [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["h" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["h" /* Validators */].minLength(6)]],
            confirmNewpwd: ['', [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["h" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["h" /* Validators */].minLength(6)]]
        }, { validator: this.matchingPasswordsForCP }); //builds the formgroup with same formcontrolname.
        var OldControl = this.ChangePasswordForm.get('Old');
        OldControl.valueChanges.subscribe(function (value) { return _this.setErrorMessageForChangePasswordForm(OldControl); });
        var NewControl_CP = this.ChangePasswordForm.get('New');
        NewControl_CP.valueChanges.subscribe(function (value) { return _this.setErrorMessageForChangePasswordForm(NewControl_CP); });
    ...
    SavePasswordPage.prototype.ngOnInit = function () {
        this.ShowIf = this.navParams.get('ischangePassword');
    };
    SavePasswordPage.prototype.setErrorMessageForPasswordField = function (c) {
        var _this = this;
        var control = this.uiService.getControlName(c); //gives the control name property from particular service.
        document.getElementById('err_' + control).innerHTML = ''; //To not display the error message, if there is no error.
        if ((c.touched || c.dirty) && c.errors) {
    ...
    SavePasswordPage.prototype.setErrorMessageForChangePasswordForm = function (c) {
        var _this = this;
    ...
    SavePasswordPage.prototype.matchingPasswords = function (group) {
    ...
    SavePasswordPage.prototype.matchingPasswordsForCP = function (group) {
        var password = group.controls.New.value;
    ...
    SavePasswordPage.prototype.OnSavePassword = function () {
        var _this = this;
        ...
        loading.present();
        this.registerService.CreateUser(userPost).subscribe(function (data) {
            if (_this.TenantId != null) {
                var user = {
                    ActiveTenantId: _this.TenantId,
                    UserId: data.UserId,
            ...
            if (typeof error === 'string') {
                ...
                var controls = _this.SavePasswordForm.controls;
                var ErrorProperties = error;
                _this.errorHandlingService.ErrorHandler(controls, ErrorProperties);
                loading.dismiss();
            }
    ...
    SavePasswordPage.prototype.OnChangePassword = function () {
        var _this = this;
        var changePassword = {
        ...
        this.registerService.ChangePassword(changePassword).subscribe(function (data) {
            if (data.IsValid == false) {
                _this.toastrService.error('SOME ERROR', 'Error!');
            }
            else {
            ...
            if (error == 401) {
                _this.registerService.SetRefreshTokenNeeded();
                _this.registerService.GetToken(__WEBPACK_IMPORTED_MODULE_3__services_Storage_Service__["a" /* StorageService */].GetItem('refreshToken')).subscribe(function (data) {
                    __WEBPACK_IMPORTED_MODULE_3__services_Storage_Service__["a" /* StorageService */].SetItem('refreshToken', data.RefreshToken);
                    _this.registerService.SetToken(data.AccessToken);
                    _this.registerService.SetRefreshTokenNeeded();
                    _this.registerService.ChangePassword(changePassword).subscribe(function (data) {
                        console.clear();
                        if (data.IsValid == false) {
                            _this.toastrService.error('SOME ERROR', 'Error!');
                        }
                ...
                var controls = _this.ChangePasswordForm.controls;
                var ErrorProperties = error;
                _this.errorHandlingService.ErrorHandler(controls, ErrorProperties);
                loading.dismiss();
            }
    ...
    SavePasswordPage.prototype.guid = function () {
        function s4() {
    ...
    SavePasswordPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad SavePasswordPage');
    };
    SavePasswordPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-save-password',template:/*ion-inline-start:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\save-password\save-password.html"*/'<!--\n  Generated template for the SavePasswordPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color="primary">\n    <ion-title>Save Password</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding class="back-image">\n  <div *ngIf="!ShowIf">\n   <form id="enterOTP-form2" [formGroup]="SavePasswordForm"  #NewPasswordEntryForm="ngForm" (ngSubmit)="OnSavePassword()">\n    <ion-item id="enterOTP-input3">\n      <ion-label floating>\n        New Password\n      </ion-label>\n      <ion-input formControlName="Password" type="password" placeholder=""></ion-input>      \n    </ion-item>\n    <p style="color:darkorange" id=\'err_Password\'></p>\n\n    <ion-item id="enterOTP-input5">\n      <ion-label floating>\n        Confirm Password\n      </ion-label>\n      <ion-input formControlName="confirmpwd" type="password" Equalvalidate="password" placeholder=""></ion-input>\n    </ion-item>\n    <p style="color:darkorange" id=\'err_confirmpwd\'></p>\n    <p style="color:darkorange" id=\'err_serverError\'></p>\n    <button [disabled]="NewPasswordEntryForm.invalid" id="enterOTP-button9" ion-button color="positive" block>\n      Save Password\n    </button>\n  </form>\n  <div style="color:red;" *ngIf="NewPasswordEntryForm.errors?.notSame"><span>Passwords do not match</span></div>\n</div>\n<div *ngIf="ShowIf">\n    <form id="enterOTP-form2" [formGroup]="ChangePasswordForm"  #ChangePasswordEntryForm="ngForm" (ngSubmit)="OnChangePassword()">\n      <ion-item id="enterOTP-input3">\n        <ion-label floating>\n          Old Password\n        </ion-label>\n        <ion-input formControlName="Old" type="password" placeholder=""></ion-input>      \n      </ion-item>\n      <p style="color:darkorange" id=\'err_Old\'></p>\n      <ion-item id="enterOTP-input3">\n      <ion-label floating>\n        New Password\n      </ion-label>\n      <ion-input formControlName="New" type="password" placeholder=""></ion-input>      \n    </ion-item>\n    <p style="color:darkorange" id=\'err_New\'></p>\n    <ion-item id="enterOTP-input5">\n      <ion-label floating>\n        Confirm Password\n      </ion-label>\n      <ion-input formControlName="confirmNewpwd" type="password" Equalvalidate="password" placeholder=""></ion-input>\n    </ion-item>\n    <p style="color:darkorange" id=\'err_confirmNewpwd\'></p>\n    <a style="color:darkorange;" (click)="OnForgot()">Forgot password?</a>\n    <button [disabled]="ChangePasswordEntryForm.invalid" id="enterOTP-button9" ion-button color="positive" block>\n      Change Password\n    </button>\n  </form>\n  <div style="color:red;" *ngIf="ChangePasswordEntryForm.errors?.notSame"><span>Passwords do not match</span></div>\n</div>\n</ion-content>\n'/*ion-inline-end:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\save-password\save-password.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_8__services_ErrorHandlingService__["a" /* ErrorHandlingService */], __WEBPACK_IMPORTED_MODULE_3__services_Storage_Service__["a" /* StorageService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_4__services_UIService__["a" /* UISercice */], __WEBPACK_IMPORTED_MODULE_5_ngx_toastr__["b" /* ToastrService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormBuilder */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */], __WEBPACK_IMPORTED_MODULE_6__services_app_data_service__["a" /* RegisterService */]])
    ], SavePasswordPage);
    return SavePasswordPage;
}());

//# sourceMappingURL=save-password.js.map
...
var StorageService = /** @class */ (function () {
    ...
    StorageService.prototype.SetLanguage = function (param) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Storage_Service__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ionic_angular__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__View_Models_ErrorFromServer__ = __webpack_require__(713);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_operators__ = __webpack_require__(296);
...
var RegisterService = /** @class */ (function () {
    ...
    function RegisterService(alertCtrl, httpclient, uIHelperService) {
        var _this = this;
        this.alertCtrl = alertCtrl;
        ...
        this.counter = 270;
        this.tick = 1000;
        this.countDown = __WEBPACK_IMPORTED_MODULE_3_rxjs_Observable__["Observable"].timer(0, this.tick)
            .take(this.counter)
            .map(function () { return --_this.counter; }); //To count down the time.
        if (this.countDown == 0) {
            var RefreshToken = __WEBPACK_IMPORTED_MODULE_4__Storage_Service__["a" /* StorageService */].GetItem('refreshToken');
            this.GetToken(RefreshToken).subscribe(function (data) {
    ...
    RegisterService.prototype.SetTenantId = function (Id) {
        this.TenantId = Id;
        return "true";
    };
    RegisterService.prototype.SetRefreshTokenNeeded = function () {
    ...
    RegisterService.prototype.SetLoginLogOut = function () {
        this.isLogOut = true;
    };
    RegisterService.prototype.RequestOTP = function (oTPRequest) {
        ...
        return this.httpclient.post(this.uIHelperService.CallWebAPIUrl("/User/RequestOTP"), body).catch(this.handleError);
    };
    ...
    RegisterService.prototype.CreateUser = function (userPost) {
        return this.httpclient.post(this.uIHelperService.CallWebAPIUrl("/User/CreateUser"), userPost).catch(this.handleError);
    };
    RegisterService.prototype.ChangePassword = function (changePassword) {
        return this.httpclient.post(this.uIHelperService.CallWebAPIUrl("/User/ChangePassword"), changePassword).catch(this.handleError);
    };
    RegisterService.prototype.Login = function (login) {
        return this.httpclient.post(this.uIHelperService.CallWebAPIUrl("/User/Login"), login).catch(this.handleError);
    };
    RegisterService.prototype.GetServices = function () {
        return this.httpclient.get(this.uIHelperService.CallWebAPIUrl("/Operator/GetServices")).catch(this.handleError);
    };
    RegisterService.prototype.GetAccounts = function (sCRequest) {
        return this.httpclient.post(this.uIHelperService.CallWebAPIUrl("/Banking/GetAccounts"), sCRequest).catch(this.handleError);
    };
    RegisterService.prototype.AddBank = function (addBankRequest) {
        return this.httpclient.post(this.uIHelperService.CallWebAPIUrl("/Banking/AddBank"), addBankRequest).catch(this.handleError);
    };
    RegisterService.prototype.GetOperators = function (oSRequest) {
        return this.httpclient.post(this.uIHelperService.CallWebAPIUrl("/Operator/GetOperators"), oSRequest).catch(this.handleError);
    };
    RegisterService.prototype.GetToken = function (refreshToken) {
        var _this = this;
        this.RefreshToken = refreshToken;
        var data = "RefreshToken=" + refreshToken;
        var url = this.uIHelperService.CallWebAPIUrl("/User/GetToken") + "?" + data;
        return this.httpclient.get(url).pipe(Object(__WEBPACK_IMPORTED_MODULE_7_rxjs_operators__["tap"])(function (data) {
    ...
    RegisterService.prototype.GetPlans = function (planRequest) {
        return this.httpclient.post(this.uIHelperService.CallWebAPIUrl("/Operator/GetPlans"), planRequest).catch(this.handleError);
    ...
    RegisterService.prototype.PostRecharge = function (rechargeModel) {
        return this.httpclient.post(this.uIHelperService.CallWebAPIUrl("/Recharge/PostRecharge"), rechargeModel).catch(this.handleError).catch(this.handleError);
    };
    RegisterService.prototype.GetFTAccount = function (fundTransferRequest) {
        return this.httpclient.post(this.uIHelperService.CallWebAPIUrl("/Banking/GetFTAccount"), fundTransferRequest).catch(this.handleError);
    };
    RegisterService.prototype.FundTransfer = function (doFundTransfer) {
        return this.httpclient.post(this.uIHelperService.CallWebAPIUrl("/Banking/FundTransfer"), doFundTransfer).catch(this.handleError);
    };
    RegisterService.prototype.CheckPassword = function (login) {
        return this.httpclient.post(this.uIHelperService.CallWebAPIUrl("/User/CheckPassword"), login).catch(this.handleError);
    };
    RegisterService.prototype.GetAccountBalance = function (statementRequest) {
        return this.httpclient.post(this.uIHelperService.CallWebAPIUrl("/Banking/GetAccountBalance"), statementRequest).catch(this.handleError);
    };
    RegisterService.prototype.GetStatement = function (statementRequest) {
        return this.httpclient.post(this.uIHelperService.CallWebAPIUrl("/Banking/GetStatement"), statementRequest).catch(this.handleError);
    };
    RegisterService.prototype.GetOperaterCircle = function (operaterCircleQuery) {
        return this.httpclient.post(this.uIHelperService.CallWebAPIUrl("/Operator/GetOperaterCircle"), operaterCircleQuery).catch(this.handleError);
    };
    RegisterService.prototype.GetRechargeReport = function (rRRequest) {
        return this.httpclient.post(this.uIHelperService.CallWebAPIUrl("/Recharge/GetRechargeReport"), rRRequest).catch(this.handleError);
    };
    RegisterService.prototype.GetLocations = function (TenantId) {
        return this.httpclient.get(this.uIHelperService.CallWebAPIUrl("/Banking/GetLocations?TenantId=" + TenantId)).catch(this.handleError);
    };
    RegisterService.prototype.GetReversedVoucher = function (checkVoucher) {
        return this.httpclient.post(this.uIHelperService.CallWebAPIUrl("/Recharge/GetReversedVoucher"), checkVoucher).catch(this.handleError);
    };
    // countDown;
    // //counter = 30*60;
    // counter = 60;
    ...
    RegisterService.prototype.handleError = function (err) {
        ...
        if (err.status == 401) {
            ...
            if (err.error != null) {
                ...
                else if (err.error instanceof __WEBPACK_IMPORTED_MODULE_6__View_Models_ErrorFromServer__["a" /* ErrorFromServer */]) {
    ...
    RegisterService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["b" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_2__UIHelperClasses_UIHelperService__["a" /* UIHelperService */]])
    ], RegisterService);
...
var RechargePage = /** @class */ (function () {
    function RechargePage(storageService, navCtrl) {
        this.storageService = storageService;
        this.navCtrl = navCtrl;
    }
    ...
    RechargePage.prototype.setBackButtonAction = function () {
        var _this = this;
        this.navBar.backButtonClick = function () {
            _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_5__page_page__["a" /* PagePage */]);
        };
    };
    ...
    // }
    RechargePage.prototype.OnPrepaid = function () {
        var isFromPrepaid = true;
        if (this.storageService.GetSelfCareAc() == null) {
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_6__login_login__["a" /* LoginPage */], { 'isFromPrepaid': isFromPrepaid });
        }
        else {
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__favourites_favourites__["a" /* FavouritesPage */], { 'ParentId': 'S1' });
        }
    };
    RechargePage.prototype.OnPostpaid = function () {
        var isFromPostpaid = true;
        if (this.storageService.GetSelfCareAc() == null) {
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_6__login_login__["a" /* LoginPage */], { 'isFromPostpaid': isFromPostpaid });
        }
        else {
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__favourites_favourites__["a" /* FavouritesPage */], { 'ParentId': 'S2' });
        }
    };
    RechargePage.prototype.OnDTH = function () {
        var isFromDTH = true;
        if (this.storageService.GetSelfCareAc() == null) {
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_6__login_login__["a" /* LoginPage */], { 'isFromDTH': isFromDTH });
        }
        else {
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__favourites_favourites__["a" /* FavouritesPage */], { 'ParentId': 'S3' });
        }
    };
    RechargePage.prototype.OnElectricity = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__favourites_favourites__["a" /* FavouritesPage */], { 'ParentId': 'S5' });
        var isFromElectricity = true;
        if (this.storageService.GetSelfCareAc() == null) {
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_6__login_login__["a" /* LoginPage */], { 'isFromElectricity': isFromElectricity });
        }
        else {
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__favourites_favourites__["a" /* FavouritesPage */], { 'ParentId': 'S5' });
        }
    ...
    RechargePage.prototype.OnReports = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__recharge_report_recharge_report__["a" /* RechargeReportPage */]);
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_11" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* Navbar */]),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* Navbar */])
    ...
    RechargePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-recharge',template:/*ion-inline-start:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\recharge\recharge.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>\n\n      Recharge \n\n    </ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding id="page7">\n\n  \n\n\n\n  <ion-list id="recharge-list6">\n\n    <!-- <ion-item color="assertive" id="recharge-list-item21" *ngFor="let row of NewCategories"  (click)="OnOperatorSelection(row.Id)">\n\n      \n\n        {{row.Operator}}\n\n      \n\n      <span style="color: blue" *ngIf="showMsg">Coming Soon</span>  \n\n    </ion-item> -->\n\n\n\n    \n\n    <ion-item color="assertive" id="banking-list-item13" (click)="OnPrepaid()">\n\n      <ion-avatar item-left>\n\n        <img src="data:image/jpeg;base64,"/>\n\n      </ion-avatar>\n\n      <h2>\n\n        Prepaid\n\n      </h2>\n\n    </ion-item>\n\n    <ion-item color="assertive" id="banking-list-item13" (click)="OnPostpaid()">\n\n      <ion-avatar item-left>\n\n        <img src= "data:image/png;base64,"/>\n\n      </ion-avatar>\n\n      <h2>\n\n        Postpaid\n\n      </h2>\n\n    </ion-item>\n\n    <ion-item color="assertive" id="banking-list-item13" (click)="OnDTH()">\n\n      <ion-avatar item-left>\n\n        <img src="data:image/png;base64,"/>\n\n      </ion-avatar>\n\n      <h2>\n\n        DTH\n\n      </h2>\n\n    </ion-item>\n\n    <ion-item color="assertive" id="banking-list-item13" (click)="OnElectricity()">\n\n      <ion-avatar item-left>\n\n        <img src="data:image/png;base64,"/>\n\n      </ion-avatar>\n\n      <h2>\n\n        Electricity Bill\n\n      </h2>\n\n    </ion-item>\n\n    <ion-item color="assertive" id="recharge-list-item21" (click)="OnReports()">\n\n      <ion-avatar item-left>\n\n        <img src="data:image/jpeg;charset=utf-8;base64,"/>\n\n      </ion-avatar>\n\n        <h2>Reports</h2>\n\n         </ion-item>\n\n  </ion-list>\n\n\n\n    \n\n</ion-content>\n\n<ion-footer>\n\n  <ion-toolbar color="primary">\n\n    <ion-title>{{ActiveBankName}} All Rights Reserved</ion-title>\n\n  </ion-toolbar>\n\n</ion-footer>'/*ion-inline-end:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\recharge\recharge.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_Storage_Service__["a" /* StorageService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */]])
    ], RechargePage);
    return RechargePage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_Storage_Service__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_app_data_service__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ngx_toastr__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__modal_modal__ = __webpack_require__(381);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RechargeReportPage = /** @class */ (function () {
        ...
        this.registerService.GetRechargeReport(rRRequest).subscribe(function (data) {
            ...
            if (error == 401) {
                ...
                _this.registerService.GetToken(__WEBPACK_IMPORTED_MODULE_2__services_Storage_Service__["a" /* StorageService */].GetItem('refreshToken')).subscribe(function (data) {
                    ...
                    _this.registerService.SetToken(data.AccessToken);
                    _this.registerService.SetRefreshTokenNeeded();
                    _this.registerService.GetRechargeReport(rRRequest).subscribe(function (data) {
                        console.clear();
                        _this.rRResponse = data;
                        loading.dismiss();
                    });
    ...
    RechargeReportPage.prototype.OnShowReverse = function (Id) {
        ...
        this.registerService.GetReversedVoucher(checkVoucher).subscribe(function (data) {
            ...
            if (error == 401) {
                _this.registerService.SetRefreshTokenNeeded();
                _this.registerService.GetToken(localStorage.getItem('refreshToken')).subscribe(function (data) {
                    localStorage.setItem('refreshToken', data.RefreshToken);
                    _this.registerService.SetToken(data.AccessToken);
                    _this.registerService.SetRefreshTokenNeeded();
                    _this.registerService.GetReversedVoucher(checkVoucher).subscribe(function (data) {
                        console.clear();
                        _this.checkVoucherResult = data;
                        _this.openModalWithParams();
                        loading.dismiss();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_Storage_Service__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_app_data_service__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_idlejs_dist__ = __webpack_require__(714);
...
var ChangeBankPage = /** @class */ (function () {
    ...
    function ChangeBankPage(storageService, navParams, alertCtrl, toastr, loadingController, events, registerService, navCtrl) {
        this.storageService = storageService;
        this.navParams = navParams;
        this.alertCtrl = alertCtrl;
        this.toastr = toastr;
    ...
    ChangeBankPage_1 = ChangeBankPage;
    //Active: number;
    ChangeBankPage.prototype.ngOnInit = function () {
        ...
        this.registerService.GetTenantsByMobile(mobno).subscribe(function (data) {
            ...
            _this.storageService.SetTenant(JSON.stringify(tenantList)); //To add tenant records from server to localstorage.
            if (_this.tenants.length < tenantList.length) {
                for (var i = 0; i < tenantList.length; i++) {
                    _this.OnAddBankSelection(tenantList[i].Id); //To add records from server to localstorage Digiparty and SelfCare.
                }
                // loading.dismiss();
            }
            _this.tenants = _this.storageService.GetTenant(); //To update the tenants property.
            loading.dismiss();
        }, function (error) {
            //this.toastr.error(error, 'Error!');
            var alert = _this.alertCtrl.create({
    ...
    ChangeBankPage.prototype.OnAddBankSelection = function (Id) {
        ...
        this.registerService.AddBank(addBankRequest).subscribe(function (data) {
            ...
            var existingDigiParty = _this.storageService.GetDigiParty(); //To get records from Digiparty table of localstorage. 
            var TenantId = tenant.Id;
            var singleDigiParty = existingDigiParty.find(function (obj) { return obj.TenantId === TenantId; }); //To find a record from localstorage DigiParty with that particular tenantId.
            ...
            var existingSelfCareAcs = _this.storageService.GetSelfCareAc(); //To get records from SelfCare table of localstorage. 
            if (existingSelfCareAcs == null) {
            }
            else {
                var singleSelfCareAC = existingSelfCareAcs.filter(function (obj) { return obj.TenantId === TenantId; }); //To find records from localstorage SelfCare table with the particular tenantId.
                if (singleSelfCareAC.length == 0) {
                    for (var j = 0; j < data.SelfCareAcs.length; j++) {
                        ...
                        existingSelfCareAcs.push(singleSelfCareAC_1); //Add each record from server to localstorge SelCare.
                    }
                    _this.storageService.SetSelfCareAc(JSON.stringify(existingSelfCareAcs));
                }
            }
            _this.events.publish('REFRESH_DIGIPARTYNAME'); //To rise the event and to show DigiPartyName.
            loading.dismiss();
        }, function (error) {
            //this.toastr.error(error, 'Error!');
            var alert = _this.alertCtrl.create({
    ...
    ChangeBankPage.prototype.OnSelect = function (order) {
        ...
        if (existingSelfCareAcs == null) {
            ...
            alert.present();
            this.navCtrl.setRoot(ChangeBankPage_1);
        }
        else {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__enter_otp_enter_otp__ = __webpack_require__(180);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__home_home__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mobile_recharge_mobile_recharge__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__banking_banking__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_app_data_service__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_ngx_toastr__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__services_ErrorHandlingService__ = __webpack_require__(49);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var GetOtpPage = /** @class */ (function () {
    function GetOtpPage(errorHandlingService, storageService, alertCtrl, uiService, navParams, loadingController, formbuilder, toastrService, regService, navCtrl) {
        var _this = this;
        this.errorHandlingService = errorHandlingService;
        this.storageService = storageService;
        this.alertCtrl = alertCtrl;
        ...
        this.formgroup1 = formbuilder.group({
            MobileNo: ['', [__WEBPACK_IMPORTED_MODULE_8__angular_forms__["h" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_8__angular_forms__["h" /* Validators */].minLength(10)]]
        }); //builds the formgroup with the same formcontrolname.
        this.formgroup1.controls['MobileNo']
            ...
            if (val && val.length < 10) {
                _this.formgroup1.controls['MobileNo'].setErrors({ minlength: true });
            }
        });
    ...
    GetOtpPage.prototype.setErrorMessage = function (c) {
        var _this = this;
    ...
    GetOtpPage.prototype.OnMobNo = function () {
        ...
        this.regService.RequestOTP(oTPRequest).subscribe(function (data) {
            ...
            _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__enter_otp_enter_otp__["a" /* EnterOTPPage */], { 'OTPRefNo': data.OTPRef, 'TenantId': ActiveTenantId, 'MobileNo': mobilenumforOTP.value });
            loading.dismiss();
        }, function (error) {
            if (typeof error === 'string') {
                //this.toastrService.error(error, 'Error!');
    ...
    GetOtpPage.prototype.goToBankList = function (params) {
        if (!params)
            params = {};
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__home_home__["a" /* HomePage */]);
    };
    GetOtpPage.prototype.goToEnterOTP = function (params) {
        if (!params)
            params = {};
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__enter_otp_enter_otp__["a" /* EnterOTPPage */]);
    };
    GetOtpPage.prototype.goToHome = function (params) {
        if (!params)
            params = {};
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__home_home__["a" /* HomePage */]);
    };
    GetOtpPage.prototype.goToMobileRecharge = function (params) {
        if (!params)
            params = {};
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__mobile_recharge_mobile_recharge__["a" /* MobileRechargePage */]);
    };
    GetOtpPage.prototype.goToBanking = function (params) {
        if (!params)
            params = {};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mobile_recharge_mobile_recharge__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__banking_banking__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_app_data_service__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__angular_forms__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_Storage_Service__ = __webpack_require__(11);
...
var EnterOTPPage = /** @class */ (function () {
    function EnterOTPPage(errorHandlingService, storageService, alertCtrl, uiService, toastrService, navParams, loadingController, fb, navCtrl, registerService) {
        var _this = this;
        this.errorHandlingService = errorHandlingService;
        this.storageService = storageService;
        this.alertCtrl = alertCtrl;
        ...
        OTPControl.valueChanges.subscribe(function (value) { return _this.setErrorMessageForOTPField(OTPControl); }); //call the particular method if value changes in the control.
    }
    ...
    EnterOTPPage.prototype.ngOnInit = function () {
        var _this = this;
        this.TenantId = this.navParams.get('TenantId');
        this.countDown = __WEBPACK_IMPORTED_MODULE_13__node_modules_rxjs__["Observable"].timer(0, this.tick)
            .take(this.counter)
            .map(function () { return --_this.counter; }); //To count down the time.
    ...
    EnterOTPPage.prototype.OnSubmit = function () {
        ...
        this.registerService.ValidateOTP(postOPT).subscribe(function (data) {
            ...
            if (_this.storeboolean == true) {
                _this.ShowIf = true; //To show SavePasswordForm based on value
                _this.HideIf = false;
                _this.ShowOldPassword = false;
                if (_this.TenantId != null) {
                    _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_11__save_password_save_password__["a" /* SavePasswordPage */], { 'TenantId': _this.TenantId });
                }
                else {
                    _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_10__register_register__["a" /* RegisterPage */]);
                }
                loading.dismiss();
            }
            else {
            ...
            if (typeof error === 'string') {
                ...
                var controls = _this.formgroup.controls;
                var ErrorProperties = error;
                _this.errorHandlingService.ErrorHandler(controls, ErrorProperties);
                loading.dismiss();
            }
...
var RegisterPage = /** @class */ (function () {
    function RegisterPage(storageService, alertCtrl, uiService, navParams, loadingController, formbuilder, toastrService, registerService, navCtrl) {
        this.storageService = storageService;
        this.alertCtrl = alertCtrl;
        this.uiService = uiService;
        this.navParams = navParams;
    ...
    RegisterPage.prototype.OnGetTenants = function () {
        ...
        loading.present();
        this.tenant = null;
        this.registerService.GetTenantsByMobile(this.registerService.MobileNo).subscribe(function (data) {
            _this.tenant = data;
            var TenantList = data;
    ...
    RegisterPage.prototype.OnAccountClick = function (Id) {
        this.registerService.SetTenantId(Id);
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_11__save_password_save_password__["a" /* SavePasswordPage */], { 'TenantId': Id });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ngx_toastr__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__banking_banking__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__node_modules_rxjs__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__node_modules_rxjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__node_modules_rxjs__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BalanceEnquiryPage = /** @class */ (function () {
    function BalanceEnquiryPage(navParams, storageService, alertCtrl, toastr, loadingController, registerService, navCtrl) {
        this.navParams = navParams;
        this.storageService = storageService;
        this.alertCtrl = alertCtrl;
        this.toastr = toastr;
    ...
    BalanceEnquiryPage.prototype.setBackButtonAction = function () {
        var _this = this;
        this.navBar.backButtonClick = function () {
            _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_5__banking_banking__["a" /* BankingPage */]);
        };
    };
    BalanceEnquiryPage.prototype.ngOnInit = function () {
        ...
        this.countDown = __WEBPACK_IMPORTED_MODULE_6__node_modules_rxjs__["Observable"].timer(0, this.tick)
            .take(this.counter)
            .map(function () { return --_this.counter; }); //To count down the time.
        if (this.navParams.get('isFromLogin') == true) {
            this.showBackButton = false;
        ...
        this.registerService.GetAccountBalance(statementRequest).subscribe(function (data) {
            ...
            if (error == 401) {
                ...
                _this.registerService.GetToken(__WEBPACK_IMPORTED_MODULE_2__services_Storage_Service__["a" /* StorageService */].GetItem('refreshToken')).subscribe(function (data) {
                    ...
                    _this.registerService.SetToken(data.AccessToken);
                    _this.registerService.SetRefreshTokenNeeded();
                    _this.registerService.GetAccountBalance(statementRequest).subscribe(function (data) {
                        console.clear();
                        _this.balance = data;
                        loading.dismiss();
                    });
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_11" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* Navbar */]),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* Navbar */])
    ], BalanceEnquiryPage.prototype, "navBar", void 0);
    BalanceEnquiryPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-balance-enquiry',template:/*ion-inline-start:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\balance-enquiry\balance-enquiry.html"*/'<ion-header>\n\n    <ion-navbar color="primary">\n\n      <button ion-button menuToggle>\n\n        <ion-icon name="menu"></ion-icon>\n\n      </button>\n\n      <ion-title>\n\n        Balance-Enquiry  {{ActiveBankName}}\n\n      </ion-title>\n\n    </ion-navbar>\n\n  </ion-header>\n\n  <ion-content padding id="page3">\n\n      <span style="color: blue" *ngIf="HideMsg">Click on Account of your wish</span>  \n\n    <div>   \n\n      <div *ngFor="let order of SelfCareAcsBasedOnTenantID" (click)="OnGetAccountBalance(order.AcHeadId,order.AcSubId)" style="background-color:#ddd;border: 1px solid lightgrey; padding: 15px; margin: 5px 0;">\n\n        <span>Name: {{order.HeadName}}</span> \n\n        <br/>\n\n        <span>Account No: {{order.AcNo}}</span> \n\n    </div> \n\n      </div>\n\n      <ion-card *ngIf="balance">\n\n        <span>Balance Amount : {{ balance.Balance|currency:\'INR\' }}</span>\n\n  </ion-card>\n\n  </ion-content>\n\n\n\n  <ion-footer color="primary">\n\n    <ion-toolbar>\n\n      <ion-title>{{ActiveBankName}}</ion-title>\n\n    </ion-toolbar>\n\n  </ion-footer>\n\n  <ion-footer>\n\n    <ion-toolbar color="primary">\n\n      <ion-title>{{ActiveBankName}} All Rights Rserved</ion-title>\n\n    </ion-toolbar>\n\n  </ion-footer>\n\n'/*ion-inline-end:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\balance-enquiry\balance-enquiry.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__services_Storage_Service__["a" /* StorageService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_4_ngx_toastr__["b" /* ToastrService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_3__services_app_data_service__["a" /* RegisterService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */]])
    ], BalanceEnquiryPage);
...
var MiniStatementPage = /** @class */ (function () {
    function MiniStatementPage(navParams, storageService, alertCtrl, toastr, loadingController, registerService, navCtrl) {
        this.navParams = navParams;
        this.storageService = storageService;
        this.alertCtrl = alertCtrl;
        this.toastr = toastr;
    ...
    MiniStatementPage.prototype.setBackButtonAction = function () {
        var _this = this;
        this.navBar.backButtonClick = function () {
            _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_5__banking_banking__["a" /* BankingPage */]);
        };
        ...
        this.registerService.GetStatement(statementRequest).subscribe(function (data) {
            ...
            if (error == 401) {
                ...
                _this.registerService.GetToken(__WEBPACK_IMPORTED_MODULE_2__services_Storage_Service__["a" /* StorageService */].GetItem('refreshToken')).subscribe(function (data) {
                    ...
                    _this.registerService.SetToken(data.AccessToken);
                    _this.registerService.SetRefreshTokenNeeded();
                    _this.registerService.GetStatement(statementRequest).subscribe(function (data) {
                        console.clear();
                        _this.balance = data;
                        _this.miniStatement = data;
                        _this.statementItem = data.StatementItems;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CheckPasswordPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_Storage_Service__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_app_data_service__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_UIService__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__payment_success_payment_success__ = __webpack_require__(384);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__services_ErrorHandlingService__ = __webpack_require__(49);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 * Ionic pages and navigation.
 */
var CheckPasswordPage = /** @class */ (function () {
    function CheckPasswordPage(errorHandlingService, viewCtrl, uiService, formbuilder, storageService, navParams, alertCtrl, toastr, loadingController, events, registerService, navCtrl) {
        var _this = this;
        this.errorHandlingService = errorHandlingService;
        ...
        var passwordControl = this.checkPasswordForm.get('password');
        passwordControl.valueChanges.subscribe(function (value) { return _this.setErrorMessage(passwordControl); });
    }
    CheckPasswordPage.prototype.setErrorMessage = function (c) {
        var _this = this;
        var control = this.uiService.getControlName(c);
        document.getElementById('err_' + control).innerHTML = '';
        if ((c.touched || c.dirty) && c.errors) {
    ...
    CheckPasswordPage.prototype.dismiss = function () {
        this.viewCtrl.dismiss();
    };
    CheckPasswordPage.prototype.onSubmit = function () {
        var _this = this;
        var loading = this.loadingController.create({
        ...
        this.registerService.CheckPassword(loginModel).subscribe(function (data) {
            if (data == true && _this.navParams.get('DoFundTransfer') != null) {
                _this.registerService.FundTransfer(_this.navParams.get('DoFundTransfer')).subscribe(function (data) {
                    _this.ftd = data;
                    _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_7__payment_success_payment_success__["a" /* PaymentSuccessPage */], { 'FTD': data });
                    _this.viewCtrl.dismiss();
                    loading.dismiss();
                });
            }
            else if (data == true && _this.navParams.get('RechargeModel') != null) {
                _this.registerService.PostRecharge(_this.navParams.get('RechargeModel')).subscribe(function (data) {
                    _this.tranResponse = data;
                    _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_7__payment_success_payment_success__["a" /* PaymentSuccessPage */], { 'TranResponse': data });
                    _this.viewCtrl.dismiss();
                    loading.dismiss();
                });
            }
            ...
            if (error == 401) {
                ...
                _this.registerService.GetToken(__WEBPACK_IMPORTED_MODULE_3__services_Storage_Service__["a" /* StorageService */].GetItem('refreshToken')).subscribe(function (data) {
                    ...
                    _this.registerService.SetToken(data.AccessToken);
                    _this.registerService.SetRefreshTokenNeeded();
                    _this.registerService.CheckPassword(loginModel).subscribe(function (data) {
                        console.clear();
                        if (data == true && _this.navParams.get('DoFundTransfer') != null) {
                            _this.registerService.FundTransfer(_this.navParams.get('DoFundTransfer')).subscribe(function (data) {
                                _this.ftd = data;
                ...
                var controls = _this.checkPasswordForm.controls;
                var ErrorProperties = error;
                _this.errorHandlingService.ErrorHandler(controls, ErrorProperties);
                loading.dismiss();
            }
    ...
    CheckPasswordPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-check-password',template:/*ion-inline-start:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\check-password\check-password.html"*/'<!--\n  Generated template for the CheckPasswordPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <!-- <ion-navbar *ngIf="!horoInfo">\n      <button ion-button menuToggle>\n          <ion-icon name="menu"></ion-icon>\n        </button>\n    <ion-title>Login</ion-title>\n  </ion-navbar>\n  <ion-navbar *ngIf="horoInfo">\n    <ion-buttons start>\n      <button ion-button (click)="dismiss()">Close</button>\n    </ion-buttons>\n    <ion-title>Login</ion-title>\n  </ion-navbar> -->\n\n<ion-navbar>  \n  <ion-buttons start>\n    <button (click)="dismiss()">\n      <ion-icon name="close-circle" style="zoom:2.0;" item-right></ion-icon>\n    </button>\n  </ion-buttons>\n  <ion-title>Enter Password</ion-title>\n</ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n  <form [formGroup]="checkPasswordForm">\n  <ion-list id="enterOTP-list18">\n    <ion-item id="enterOTP-input12">\n      <ion-label floating>\n        Password\n      </ion-label>\n    <ion-input formControlName="password" type="password" placeholder=""></ion-input>\n</ion-item>\n</ion-list>\n<p style="color:darkorange" id=\'err_password\'></p>\n<br/><br/> \n  <button [disabled]="checkPasswordForm.invalid" id="login-button1" ion-button color="assertive" block (click)="onSubmit()">\n    Submit\n  </button>\n  <br>\n<button ion-button color="danger" full (click)="dismiss()">Cancel</button>\n  </form>\n\n  <div style="color:red;" *ngIf="checkPasswordForm.errors?.notSame"><span>Passwords do not match</span></div>\n</ion-content>'/*ion-inline-end:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\check-password\check-password.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_8__services_ErrorHandlingService__["a" /* ErrorHandlingService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* ViewController */], __WEBPACK_IMPORTED_MODULE_6__services_UIService__["a" /* UISercice */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormBuilder */], __WEBPACK_IMPORTED_MODULE_3__services_Storage_Service__["a" /* StorageService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_4_ngx_toastr__["b" /* ToastrService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["c" /* Events */], __WEBPACK_IMPORTED_MODULE_5__services_app_data_service__["a" /* RegisterService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */]])
    ], CheckPasswordPage);
...
var BankBranchesPage = /** @class */ (function () {
        ...
        this.registerService.GetLocations(ActiveTenantId).subscribe(function (data) {
            ...
            if (error == 401) {
                ...
                _this.registerService.GetToken(__WEBPACK_IMPORTED_MODULE_2__services_Storage_Service__["a" /* StorageService */].GetItem('refreshToken')).subscribe(function (data) {
                    ...
                    _this.registerService.SetToken(data.AccessToken);
                    _this.registerService.SetRefreshTokenNeeded();
                    _this.registerService.GetLocations(ActiveTenantId).subscribe(function (data) {
                        console.clear();
                        _this.bankBranch = data;
                        loading.dismiss();
                    });
    ...
    BankBranchesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-bank-branches',template:/*ion-inline-start:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\bank-branches\bank-branches.html"*/'<!--\n\n  Generated template for the BankBranchesPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n  <ion-navbar color="primary">\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>Bank Branches</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <div *ngFor="let order of bankBranch" style="background-color:#ddd;border: 1px solid lightgrey; padding: 15px; margin: 5px 0;">\n\n    <span>Name: {{order.Name}}</span> \n\n    <br/>\n\n    <span>Mail Name:{{order.MailName}}</span> \n\n    <br/>\n\n    <span>Mobile No:{{order.MobileNo}}</span> \n\n</div> \n\n</ion-content>\n\n'/*ion-inline-end:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\bank-branches\bank-branches.html"*/,
        }),
...
var BankingPage = /** @class */ (function () {
    ...
    function BankingPage(navParams, storageService, navCtrl) {
        //StorageService.SetItem('lastAction', Date.now().toString());
        this.navParams = navParams;
        this.storageService = storageService;
        this.navCtrl = navCtrl;
    ...
    BankingPage.prototype.OnFundTransfer = function () {
        ...
        var isFromFundTransfer = true;
        if (this.storageService.GetSelfCareAc() == null) {
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_7__login_login__["a" /* LoginPage */], { 'isFromFundTransfer': isFromFundTransfer }).then(function () {
                var startIndex = _this.navCtrl.getActive().index - 1;
                _this.navCtrl.remove(startIndex, 1); //removes the history of this page.
            });
        }
    ...
    BankingPage.prototype.OnBalanceEnquiry = function () {
        var isFromBalanceEnquiry = true;
        if (this.storageService.GetSelfCareAc() == null) {
            // const startIndex = this.navCtrl.getActive().index;
            // const startIndex = this.navCtrl.getActive().index - 1;
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_7__login_login__["a" /* LoginPage */], { 'isFromBalanceEnquiry': isFromBalanceEnquiry });
            // .then(() => {  
    ...
    BankingPage.prototype.ionViewDidEnter = function () {
    };
    BankingPage.prototype.ionViewDidLoad = function () {
        this.setBackButtonAction();
    };
    BankingPage.prototype.setBackButtonAction = function () {
        var _this = this;
        this.navBar.backButtonClick = function () {
    ...
    BankingPage.prototype.OnMiniStatement = function () {
        var _this = this;
        var isFromMiniStatement = true;
        if (this.storageService.GetSelfCareAc() == null) {
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_7__login_login__["a" /* LoginPage */], { 'isFromMiniStatement': isFromMiniStatement }).then(function () {
                var startIndex = _this.navCtrl.getActive().index - 1;
                _this.navCtrl.remove(startIndex, 1); //removes the history of this page.
            });
        }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_app_data_service__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__page_page__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__services_Storage_Service__ = __webpack_require__(11);
...
var LoginPage = /** @class */ (function () {
    ...
    LoginPage.prototype.OnLogin = function () {
        ...
        this.registerService.Login(Login).subscribe(function (data) {
            _this.registerService.AccessToken = data.AccessToken;
            __WEBPACK_IMPORTED_MODULE_8__services_Storage_Service__["a" /* StorageService */].SetItem('refreshToken', data.RefreshToken);
            _this.sendToken(data.AccessToken); //stores the token in service property.
            if (OS == null) {
                ...
                _this.registerService.GetServices().subscribe(function (data) {
                    ...
                    _this.storageService.SetOS(oS); //To store the OS table in localstorage.
                    loading_1.dismiss();
                }, function (error) {
                    // this.toastrService.error(error, 'Error!');
                    var alert = _this.alertCtrl.create({
            ...
            if (tenants == null || DigiParties == null || SelfCareAcs == null) {
                ...
                loadingnew.present();
                _this.callservices(); //To add tables to localstorage, for the first time login.
                //this.navCtrl.setRoot(PagePage);
                loadingnew.dismiss();
            }
            else {
    ...
    LoginPage.prototype.callservices = function () {
        ...
        this.registerService.AddBank(addBankRequest).subscribe(function (data) {
            ...
            _this.registerService.SetLoginLogOut();
            _this.events.publish('REFRESH_DIGIPARTYNAME');
            if (_this.navParams.get('isFromFundTransfer') == true) {
                var isFromLogin = true;
                _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_12__fund_transfer_fund_transfer__["a" /* FundTransferPage */], { 'isFromLogin': isFromLogin }).then(function () {
                    var startIndex = _this.navCtrl.getActive().index - 1;
                    _this.navCtrl.remove(startIndex, 1); //removes the history of this page.
                });
            }
            else if (_this.navParams.get('isFromBalanceEnquiry') == true) {
                var isFromLogin = true;
                var startIndex = _this.navCtrl.getActive().index;
                //const startIndex = this.navCtrl.getActive().index - 1;
                _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_13__balance_enquiry_balance_enquiry__["a" /* BalanceEnquiryPage */], { 'isFromLogin': isFromLogin });
                // .then(() => {  
                _this.navCtrl.remove(startIndex, 1); //removes the history of this page.
                //   const startIndex = this.navCtrl.getActive().index;
                //   this.navCtrl.remove(0, startIndex); 
            ...
            else if (_this.navParams.get('isFromMiniStatement') == true) {
                var isFromLogin = true;
                _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_14__mini_statement_mini_statement__["a" /* MiniStatementPage */], { 'isFromLogin': isFromLogin }).then(function () {
                    var startIndex = _this.navCtrl.getActive().index - 1;
                    _this.navCtrl.remove(startIndex, 1); //removes the history of this page.
                });
                // const startIndex = this.navCtrl.getActive().index;
            ...
            else if (_this.navParams.get('isFromPrepaid') == true) {
                var isFromLogin = true;
                _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_15__favourites_favourites__["a" /* FavouritesPage */], { 'isFromLogin': isFromLogin, 'ParentId': 'S1' }).then(function () {
                    var startIndex = _this.navCtrl.getActive().index - 1;
                    _this.navCtrl.remove(startIndex, 1); //removes the history of this page.
                });
            }
            else if (_this.navParams.get('isFromPostpaid') == true) {
                var isFromLogin = true;
                _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_15__favourites_favourites__["a" /* FavouritesPage */], { 'isFromLogin': isFromLogin, 'ParentId': 'S2' }).then(function () {
                    var startIndex = _this.navCtrl.getActive().index - 1;
                    _this.navCtrl.remove(startIndex, 1); //removes the history of this page.
                });
            }
            else if (_this.navParams.get('isFromDTH') == true) {
                var isFromLogin = true;
                _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_15__favourites_favourites__["a" /* FavouritesPage */], { 'isFromLogin': isFromLogin, 'ParentId': 'S3' }).then(function () {
                    var startIndex = _this.navCtrl.getActive().index - 1;
                    _this.navCtrl.remove(startIndex, 1); //removes the history of this page.
                });
            }
            else if (_this.navParams.get('isFromElectricity') == true) {
                var isFromLogin = true;
                _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_15__favourites_favourites__["a" /* FavouritesPage */], { 'isFromLogin': isFromLogin, 'ParentId': 'S5' }).then(function () {
                    var startIndex = _this.navCtrl.getActive().index - 1;
                    _this.navCtrl.remove(startIndex, 1); //removes the history of this page.
                });
            }
    ...
    LoginPage.prototype.OnForgot = function () {
        ...
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_11__get_otp_get_otp__["a" /* GetOtpPage */], { 'isForgotPassword': this.isForgotten });
    };
...
var UIHelperService = /** @class */ (function () {
    function UIHelperService() {
        ...
        this.baseUrl = 'https://sahakariapi.azurewebsites.net/api';
    }
    UIHelperService.prototype.CallWebAPIUrl = function (api_action) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ngx_toastr__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_app_data_service__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_Storage_Service__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__mobile_recharge_mobile_recharge__ = __webpack_require__(39);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BasicPage = /** @class */ (function () {
    function BasicPage(storageService, alertCtrl, viewCtrl, toastr, registerService, loadingController, navParams, navCtrl, platform) {
        var _this = this;
        this.storageService = storageService;
        this.alertCtrl = alertCtrl;
        this.viewCtrl = viewCtrl;
        ...
        this.registerService.GetPlans(planRequest).subscribe(function (data) {
            ...
            if (error == '401') {
                _this.registerService.SetRefreshTokenNeeded();
                _this.registerService.GetToken(__WEBPACK_IMPORTED_MODULE_4__services_Storage_Service__["a" /* StorageService */].GetItem('refreshToken')).subscribe(function (data) {
                    __WEBPACK_IMPORTED_MODULE_4__services_Storage_Service__["a" /* StorageService */].SetItem('refreshToken', data.RefreshToken);
                    _this.registerService.SetToken(data.AccessToken);
                    _this.registerService.SetRefreshTokenNeeded();
                    _this.registerService.GetPlans(planRequest).subscribe(function (data) {
                        console.clear();
                        _this.planResponse = data;
                        loading.dismiss();
                    });
    ...
    BasicPage.prototype.slideChanged = function () {
        ...
        this.registerService.GetPlans(planRequest).subscribe(function (data) {
            _this.planResponse = data; //To load active index data
            loading.dismiss();
        }, function (error) {
            if (error == '401') {
                _this.registerService.SetRefreshTokenNeeded();
    ...
    BasicPage.prototype.OnAmount = function (amount) {
        ...
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_5__mobile_recharge_mobile_recharge__["a" /* MobileRechargePage */], { 'Amount': amount, 'ParentId': this.navParams.get('ParentId'), 'OperatorId': this.navParams.get('OperatorId'), 'CircleId': this.navParams.get('CircleId'), 'SubscriptionId': this.navParams.get('SubscriptionId'), 'nname': this.navParams.get('nname'), 'ButtonEnabled': this.isButtonEnabled });
    };
    __decorate([
...
var ModalPage = /** @class */ (function () {
    ...
    ModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-modal',template:/*ion-inline-start:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\modal\modal.html"*/'<ion-header>\n\n\n\n  <ion-navbar color="primary">\n\n    <ion-buttons start>\n\n      <!-- <button ion-button (click)="dismiss()">Close</button> -->\n\n\n\n      <button (click)="dismiss()">\n\n        <ion-icon name="close-circle" style="zoom:2.0;" item-right></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n    <ion-title>Reversed Voucher Detail</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <ion-card [hidden]="!myParam">\n\n    <ion-card-content>\n\n    <p ion-text color=\'danger\'>Reversal Transaction ID: {{VendorExtCode}}</p>\n\n    <p ion-text color=\'danger\'>Amount: {{Amount|currency:\'INR\'}}</p>\n\n    <p ion-text color=\'danger\'>Date: {{Date|date:\'dd/MM/yyyy\'}}</p>\n\n    <p ion-text color=\'danger\'>Remarks: {{Remarks}}</p>\n\n  </ion-card-content>\n\n  </ion-card>\n\n  <div [hidden]="myParam">\n\n    <p>No parameters passed.</p>\n\n  </div>\n\n  <!-- <button ion-button color="danger" (click)="dismiss()">Close</button> -->\n\n\n\n</ion-content>'/*ion-inline-end:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\modal\modal.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_app_data_service__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_Storage_Service__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__check_password_check_password__ = __webpack_require__(184);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FundTransferConfirmPage = /** @class */ (function () {
    function FundTransferConfirmPage(modalCtrl, storageService, alertCtrl, toastr, loadingController, registerService, navCtrl, navParams) {
        this.modalCtrl = modalCtrl;
        this.storageService = storageService;
        this.alertCtrl = alertCtrl;
        this.toastr = toastr;
    ...
    FundTransferConfirmPage.prototype.OnConfirm = function () {
        ...
        var passwordModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_5__check_password_check_password__["a" /* CheckPasswordPage */], { 'DoFundTransfer': doFundTransfer }, myModalOptions);
...
var PaymentSuccessPage = /** @class */ (function () {
    function PaymentSuccessPage(storageService, alertCtrl, toastr, navCtrl, navParams) {
        this.storageService = storageService;
        this.alertCtrl = alertCtrl;
        this.toastr = toastr;
        this.navCtrl = navCtrl;
    ...
    PaymentSuccessPage.prototype.ionViewDidLoad = function () {
    ...
    PaymentSuccessPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-payment-success',template:/*ion-inline-start:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\payment-success\payment-success.html"*/'<!--\n  Generated template for the PaymentSuccessPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color=\'primary\'>\n    <ion-title *ngIf="showstatus">Fund Transfered </ion-title>\n    <ion-title *ngIf="showFailureFT">Fund Transfer Failured</ion-title>\n    <ion-title *ngIf="showSuccess||showPending||showInit||showFailure||showRefund||showBlocked">\n      <!-- <ion-title *ngIf="showSuccess"> -->\n      {{OperatorService}} Recharge -{{ActiveBankName}}\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n  <div *ngIf="showstatus">\n    <h1>Fund transferred with Success</h1>\n  </div>\n  <div *ngIf="showFailureFT">\n    <h1>Fund transfer failed</h1>\n  </div>\n  <div *ngIf="showSuccess">\n    <h1 style="color: green;">Recharge is Successful...</h1>\n    <p>Transaction ID: {{tranResponse.VendorExtCode}}</p>\n  </div>\n  <div *ngIf="showPending">\n    <h1 style="color: darkorange;">Recharge is Pending...</h1>\n    <p>Transaction ID: {{tranResponse.VendorExtCode}}</p>\n    <p>You will notified through message, After recharge Successful</p>\n  </div>\n  <div *ngIf="showInit">\n    <h1>Recharge is Initiated...Please wait for a minute..</h1>\n    <p>Transaction ID: {{tranResponse.VendorExtCode}}</p>\n  </div>\n  <div *ngIf="showFailure">\n    <h1 style="color: red;">Sorry, Recharge is Unsuccessful...</h1>\n    <p>Transaction ID: {{tranResponse.VendorExtCode}}</p>\n  </div>\n  <div *ngIf="showRefund">\n    <h1>Recharge is Refunded due to some issues...</h1>\n    <p>Transaction ID: {{tranResponse.VendorExtCode}}</p>\n  </div>\n  <div *ngIf="showBlocked">\n    <h1>Recharge is Blocked due to some issues...</h1>\n  </div>\n</ion-content>'/*ion-inline-end:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\payment-success\payment-success.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_Storage_Service__["a" /* StorageService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_2_ngx_toastr__["b" /* ToastrService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */]])
    ], PaymentSuccessPage);
...
var PrepaidConfirmPage = /** @class */ (function () {
    function PrepaidConfirmPage(modalCtrl, storageService, alertCtrl, toastr, registerService, loadingController, navCtrl, navParams) {
        this.modalCtrl = modalCtrl;
        this.storageService = storageService;
        this.alertCtrl = alertCtrl;
        this.toastr = toastr;
    ...
    PrepaidConfirmPage.prototype.OnConfirm = function () {
        ...
        var passwordModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_5__check_password_check_password__["a" /* CheckPasswordPage */], { 'RechargeModel': rechargeModel }, myModalOptions);
        passwordModal.present();
    };
    ...
    PrepaidConfirmPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-prepaid-confirm',template:/*ion-inline-start:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\prepaid-confirm\prepaid-confirm.html"*/'<!--\n\n  Generated template for the PrepaidConfirmPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n  <ion-navbar color="primary">\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title *ngIf="showTitle">\n\n      Confirm {{OperatorService}} Recharge-{{ActiveBankName}}\n\n    </ion-title>\n\n    <ion-title *ngIf="showSuccess||showPending||showInit||showFailure||showRefund||showBlocked">\n\n        <!-- <ion-title *ngIf="showSuccess"> -->\n\n      {{OperatorService}} Recharge -{{ActiveBankName}}\n\n    </ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <div class="row" *ngIf="showTitle">\n\n    <div class="col s12 m7">\n\n      <div class="card">\n\n          <!--interpolation-->\n\n        <div class="card-content">     \n\n        <span>Selected Operator : {{ operator }}</span> <br>\n\n        <span>Mobile No : {{ SubscriptionId }}</span> <br>\n\n        <span>Recharge Amount : {{ Amount }}</span> <br>\n\n        </div>       \n\n      </div>\n\n    </div>\n\n    <button id="register-button8" ion-button color="positive" type="button" (click)="OnConfirm()" block>\n\n      Confirm\n\n    </button>\n\n  </div>\n\n</ion-content>\n\n'/*ion-inline-end:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\prepaid-confirm\prepaid-confirm.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* ModalController */], __WEBPACK_IMPORTED_MODULE_2__services_Storage_Service__["a" /* StorageService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_4_ngx_toastr__["b" /* ToastrService */], __WEBPACK_IMPORTED_MODULE_3__services_app_data_service__["a" /* RegisterService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */]])
    ], PrepaidConfirmPage);
...
var SettingPage = /** @class */ (function () {
    function SettingPage(storageService, events, translate, navCtrl) {
        this.storageService = storageService;
        this.events = events;
    ...
    SettingPage.prototype.changeLanguage = function (language) {
        this.translate.use(language);
        this.storageService.SetLanguage(language);
        this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_3__page_page__["a" /* PagePage */]);
        this.events.publish('REFRESH_DIGIPARTYNAME');
    };
    SettingPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-setting',template:/*ion-inline-start:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\setting\setting.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>\n\n      Settings\n\n    </ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding id="page2">\n\n<!-- \n\n  <ion-item>\n\n    <button ion-button (click)="changeLanguage(\'ka\')" >{{ \'demo.kannada\'| translate }}</button>\n\n    <button ion-button (click)="changeLanguage(\'en\')">{{ \'demo.english\'| translate }}</button>\n\n  </ion-item> -->\n\n  <ion-list radio-group>\n\n      <ion-list-header>\n\n        Select Language\n\n      </ion-list-header>\n\n  \n\n      <ion-item>\n\n        <ion-label>{{ \'Kannada\'| translate }}</ion-label>\n\n        <ion-radio (ionSelect)="changeLanguage(\'ka\')" checked="{{isKannada}}"></ion-radio>\n\n      </ion-item>\n\n  \n\n      <ion-item>\n\n          <ion-label>{{ \'English\'| translate }}</ion-label>\n\n          <ion-radio (ionSelect)="changeLanguage(\'en\')" checked="{{isEnglish}}"></ion-radio>\n\n        </ion-item>\n\n      </ion-list>\n\n</ion-content>'/*ion-inline-end:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\setting\setting.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4__services_Storage_Service__["a" /* StorageService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["c" /* Events */], __WEBPACK_IMPORTED_MODULE_2__ngx_translate_core__["c" /* TranslateService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */]])
    ], SettingPage);
    return SettingPage;
}());
...
var MyProfilePage = /** @class */ (function () {
    function MyProfilePage(event, toastrService, loadingController, alertCtrl, storageService, registerService, navCtrl, navParams) {
        this.event = event;
        this.toastrService = toastrService;
        this.loadingController = loadingController;
        this.alertCtrl = alertCtrl;
    ...
    MyProfilePage.prototype.ngOnInit = function () {
        ...
        this.registerService.GetTenantsByMobile(this.mobileno).subscribe(function (data) {
            ...
            _this.storageService.SetTenant(JSON.stringify(_this.tenantList)); //To update the Tenant table of localstorage
            _this.tenants = _this.storageService.GetTenant(); //To show bank branchs
            loading.dismiss();
        }, function (error) {
            // this.toastrService.error(error, 'Error!');
            var alert = _this.alertCtrl.create({
        ...
        this.event.subscribe('REFRESH_isLogOutSetFalse', function () {
            _this.isLogOut = false;
            _this.registerService.isLogOut = false;
        });
        this.event.subscribe('REFRESH_isLogOutSetTrue', function () {
            _this.isLogOut = true;
            _this.registerService.isLogOut = true;
        });
    };
    MyProfilePage.prototype.OnChange = function () {
        var ischangePassword = true;
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_7__save_password_save_password__["a" /* SavePasswordPage */], { 'ischangePassword': ischangePassword });
    };
            ...
            buttons: [
                {
                    ...
                    handler: function () {
                        _this.isLogOut = false;
                        _this.event.publish('REFRESH_isLogOutSetFalse');
                    }
                },
                {
                    text: 'OK',
                    handler: function () {
                        _this.onOK();
                        _this.event.publish('REFRESH_isLogOutSetTrue');
                    }
                }
            ]
        });
    ...
    MyProfilePage.prototype.onOK = function () {
        this.storageService.RemoveRecordsForLogout();
        this.isLogOut = true;
    };
    MyProfilePage.prototype.OnLogin = function () {
    ...
    MyProfilePage.prototype.callservices = function () {
        ...
        this.registerService.AddBank(addBankRequest).subscribe(function (data) {
            ...
            _this.storageService.SetDigiParty(JSON.stringify([digiParty]));
            _this.storageService.SetSelfCareAc(JSON.stringify(data.SelfCareAcs));
            _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_6__page_page__["a" /* PagePage */], { 'ActiveBankName': ActiveBankName });
        }, function (error) {
            // this.toastrService.error(error, 'Error!');
            var alert = _this.alertCtrl.create({
                title: "Error Message",
    ...
    MyProfilePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-my-profile',template:/*ion-inline-start:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\my-profile\my-profile.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>\n\n      My Profile\n\n    </ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding id="page1">\n\n  <ion-card id="home-card21">\n\n    <ion-list>\n\n      <ion-item color="none" id="home-list-item6">\n\n        <ion-icon name="person" item-left></ion-icon>\n\n         {{digipartyname}}\n\n      </ion-item>\n\n      <div style="width:100%;background-color:#e8ebef;text-align:center;">\n\n        <i class="icon ion-image" style="font-size:64px;color:#888;vertical-align:middle;"></i>\n\n      </div>\n\n      <ion-item color="none" id="home-list-item7">\n\n        <ion-icon name="phone-portrait" item-left></ion-icon>\n\n       {{mobileno}}\n\n      </ion-item>\n\n    </ion-list>\n\n  </ion-card>\n\n  <ion-card id="home-card25"><ion-card-content>\n\n\n\n      <ion-card-title>\n\n          Linked Bank Accounts\n\n        </ion-card-title>\n\n    <ion-list>\n\n \n\n      <ion-item color="none" id="home-list-item18" *ngFor="let order of tenants">\n\n        <h2 style="text-transform:capitalize;">{{ order.Name }}</h2>\n\n    <p>Branch:{{ order.Address }}</p>\n\n      </ion-item>\n\n      </ion-list>\n\n    </ion-card-content>\n\n  </ion-card>\n\n  <ion-card id="home-card26">\n\n    <ion-list>\n\n      <div style="width:100%; background-color:#e8ebef;text-align:center;">\n\n        <i class="icon ion-image" style="font-size:64px;color:#888;vertical-align:middle;"></i>\n\n      </div>\n\n      <ion-item color="none" id="home-list-item21">\n\n        <ion-icon name="lock" item-left></ion-icon>\n\n        <a style="color:darkorange;" (click)="OnChange()">Change password?</a>\n\n      </ion-item>\n\n    </ion-list>\n\n  </ion-card>\n\n  <ion-card id="home-card27">\n\n    <ion-list *ngIf=\'!isLogOut\'>\n\n      <div style="width:100%;background-color:#e8ebef;text-align:center;">\n\n        <i class="icon ion-image" style="font-size:64px;color:#888;vertical-align:middle;"></i>\n\n      </div>\n\n      <ion-item color="assertive" id="home-list-item23">\n\n        <ion-icon name="log-out" item-left></ion-icon>\n\n        <a style="color:darkorange;" (click)="OnLogOut()">Log out</a>\n\n      </ion-item>\n\n    </ion-list>\n\n    <ion-list *ngIf=\'isLogOut\'>\n\n      <div style="width:100%;background-color:#e8ebef;text-align:center;">\n\n        <i class="icon ion-image" style="font-size:64px;color:#888;vertical-align:middle;"></i>\n\n      </div>\n\n      <ion-item color="assertive" id="home-list-item23">\n\n        <ion-icon name="log-in" item-left></ion-icon>\n\n        <a style="color:darkorange;" (click)="OnLogin()">Login</a>\n\n      </ion-item>\n\n    </ion-list>\n\n  </ion-card>\n\n</ion-content>'/*ion-inline-end:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\my-profile\my-profile.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["c" /* Events */], __WEBPACK_IMPORTED_MODULE_5_ngx_toastr__["b" /* ToastrService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_2__services_Storage_Service__["a" /* StorageService */], __WEBPACK_IMPORTED_MODULE_3__services_app_data_service__["a" /* RegisterService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */]])
    ], MyProfilePage);
...
var ContactUsPage = /** @class */ (function () {
    ...
    ContactUsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-contact-us',template:/*ion-inline-start:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\contact-us\contact-us.html"*/'<!--\n  Generated template for the ContactUsPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color=\'primary\'>\n      <button ion-button menuToggle>\n          <ion-icon name="menu"></ion-icon>\n        </button>\n    <ion-title>Contact Us</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <ion-card>\n    <ion-item>\n<h2 style="color:blueviolet">For Any Technical queries, Contact at below Mail Address</h2>\n    <a style="color:crimson" href="mailto:support@aisplanet.com">support@aisplanet.com</a>\n</ion-item>\n  </ion-card>\n</ion-content>'/*ion-inline-end:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\contact-us\contact-us.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(186);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_app_data_service__ = __webpack_require__(13);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_app_data_service__["a" /* RegisterService */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */]])
    ], AuthGuard);
    return AuthGuard;
}());
...
var MobileRechargePage = /** @class */ (function () {
    function MobileRechargePage(errorHandlingService, storageService, alertCtrl, uiService, viewCtrl, toastr, registerService, loadingController, navParams, navCtrl, formbuilder) {
        var _this = this;
        this.errorHandlingService = errorHandlingService;
        this.storageService = storageService;
        this.alertCtrl = alertCtrl;
            ...
            if (control === 'subscriptionId' && subscriptionId.value != null && (this.ParentId == "S3" || this.ParentId == "S5")) {
                ...
                if (c.errors.minlength) {
                    if (c.errors.minlength.requiredLength == 9) {
                        ...
                        //maps the error message from validationMessages array.
                        document.getElementById('err_' + control).innerHTML = Object.keys(c.errors).map(function (key) { return _this.validationMessages[control + '_' + key + '_9']; }).join(' ');
                        this.subscriptionIdInfo = '';
                    }
                    else if (c.errors.minlength.requiredLength == 10) {
                        document.getElementById('err_' + control).innerHTML = Object.keys(c.errors).map(function (key) { return _this.validationMessages[control + '_' + key + '_10']; }).join(' ');
                        this.subscriptionIdInfo = '';
                    }
                    else if (c.errors.minlength.requiredLength == 11) {
                        document.getElementById('err_' + control).innerHTML = Object.keys(c.errors).map(function (key) { return _this.validationMessages[control + '_' + key + '_11']; }).join(' ');
                        this.subscriptionIdInfo = '';
                    }
                    else if (c.errors.minlength.requiredLength == 12) {
                        document.getElementById('err_' + control).innerHTML = Object.keys(c.errors).map(function (key) { return _this.validationMessages[control + '_' + key + '_12']; }).join(' ');
                        this.subscriptionIdInfo = '';
                    }
                }
                    ...
                    if (c.errors.pattern.requiredPattern == "^0[0-9]{10}$") {
                        document.getElementById('err_' + control).innerHTML = Object.keys(c.errors).map(function (key) { return _this.validationMessages[control + '_' + key + '_0']; }).join(' ');
                        this.subscriptionIdInfo = '';
                    }
                    else if (c.errors.pattern.requiredPattern == "^1[0-9]{9}$") {
                        document.getElementById('err_' + control).innerHTML = Object.keys(c.errors).map(function (key) { return _this.validationMessages[control + '_' + key + '_1']; }).join(' ');
                        this.subscriptionIdInfo = '';
                    }
                    else if (c.errors.pattern.requiredPattern == "^2[0-9]{11}$") {
                        document.getElementById('err_' + control).innerHTML = Object.keys(c.errors).map(function (key) { return _this.validationMessages[control + '_' + key + '_2']; }).join(' ');
                        this.subscriptionIdInfo = '';
                    }
                    else if (c.errors.pattern.requiredPattern == "^3[0-9]{9}$") {
                        document.getElementById('err_' + control).innerHTML = Object.keys(c.errors).map(function (key) { return _this.validationMessages[control + '_' + key + '_3']; }).join(' ');
                        this.subscriptionIdInfo = '';
                    }
                }
    ...
    MobileRechargePage.prototype.setBackButtonAction = function () {
        var _this = this;
        this.navBar.backButtonClick = function () {
            _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_7__favourites_favourites__["a" /* FavouritesPage */]).then(function () {
        ...
        this.registerService.GetOperators(oSRequest).subscribe(function (data) {
            ...
            if (error == 401) {
                ...
                _this.registerService.GetToken(__WEBPACK_IMPORTED_MODULE_3__services_Storage_Service__["a" /* StorageService */].GetItem('refreshToken')).subscribe(function (data) {
                    ...
                    _this.registerService.SetToken(data.AccessToken);
                    _this.registerService.SetRefreshTokenNeeded();
                    _this.registerService.GetOperators(oSRequest).subscribe(function (data) {
                        console.clear();
                        _this.OSResponseNew = data;
                        var OSResponseNew = data;
                        _this.OSResponseNew = OSResponseNew.filter(function (obj) { return obj.TenantId === ActiveTenantId; });
    ...
    MobileRechargePage.prototype.ionViewWillLeave = function () {
        //this.ParentId='S1';
    ...
    MobileRechargePage.prototype.OnNext = function () {
        ...
        if (this.Id == null) {
            ...
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_8__prepaid_confirm_prepaid_confirm__["a" /* PrepaidConfirmPage */], { 'ParentId': this.ParentId, 'Operator': this.operator, 'OperatorId': operatorId.value, 'SubscriptionId': subscriptionId.value, 'Amount': amount.value });
        }
        else {
        ...
        if (id.length < 10) {
            ...
            this.registerService.GetOperaterCircle(operaterCircleQuery).subscribe(function (data) {
                ...
                if (data.ResponseMessage == null) {
                    ...
                    var circle = _this.operatorCircle.circle;
                    _this.statename = _this.operatorCircle.circle;
                ...
                if (error == 401) {
                    ...
                    _this.registerService.GetToken(__WEBPACK_IMPORTED_MODULE_3__services_Storage_Service__["a" /* StorageService */].GetItem('refreshToken')).subscribe(function (data) {
                        ...
                        _this.registerService.SetToken(data.AccessToken);
                        _this.registerService.SetRefreshTokenNeeded();
                        _this.registerService.GetOperaterCircle(operaterCircleQuery).subscribe(function (data) {
                            console.clear();
                            _this.operatorCircle = data;
                            var operatorCircle = data;
                            if (data.ResponseMessage == null) {
    ...
    MobileRechargePage.prototype.OnGoBack = function () {
        this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_9__page_page__["a" /* PagePage */]);
    };
    ...
    MobileRechargePage.prototype.OnViewPlans = function () {
        ...
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_6__ViewPlans_Tabs_ViewPlans_Tabs__["a" /* BasicPage */], { 'OperatorId': operatorId.value, 'CircleId': circleId.value, 'ParentId': this.ParentId, 'SubscriptionId': subscriptionId.value, 'nname': nickname.value });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_setting_setting__ = __webpack_require__(386);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_change_bank_change_bank__ = __webpack_require__(178);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_banking_banking__ = __webpack_require__(31);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__pages_enter_otp_enter_otp__ = __webpack_require__(180);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23_ionic2_auto_complete__ = __webpack_require__(717);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__pages_services_app_data_service__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__pages_UIHelperClasses_UIHelperService__ = __webpack_require__(379);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__pages_auth_auth_interceptor__ = __webpack_require__(718);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__angular_router__ = __webpack_require__(186);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__pages_prepaid_confirm_prepaid_confirm__ = __webpack_require__(385);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__pages_services_UIService__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__pages_my_profile_my_profile__ = __webpack_require__(387);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__pages_bank_branches_bank_branches__ = __webpack_require__(185);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_48__pages_contact_us_contact_us__ = __webpack_require__(388);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_49__pages_services_ErrorHandlingService__ = __webpack_require__(49);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_22__pages_enter_otp_enter_otp__["a" /* EnterOTPPage */],
                __WEBPACK_IMPORTED_MODULE_33__pages_fund_transfer_fund_transfer__["a" /* FundTransferPage */],
                __WEBPACK_IMPORTED_MODULE_34__pages_balance_enquiry_balance_enquiry__["a" /* BalanceEnquiryPage */],
                __WEBPACK_IMPORTED_MODULE_35__pages_ViewPlans_Tabs_ViewPlans_Tabs__["a" /* BasicPage */],
                __WEBPACK_IMPORTED_MODULE_36__pages_recharge_report_recharge_report__["a" /* RechargeReportPage */],
                __WEBPACK_IMPORTED_MODULE_37__pages_prepaid_confirm_prepaid_confirm__["a" /* PrepaidConfirmPage */],
                __WEBPACK_IMPORTED_MODULE_22__pages_enter_otp_enter_otp__["b" /* FormatTimePipe */],
                __WEBPACK_IMPORTED_MODULE_39__pages_my_profile_my_profile__["a" /* MyProfilePage */],
                __WEBPACK_IMPORTED_MODULE_40__pages_bank_branches_bank_branches__["a" /* BankBranchesPage */],
                __WEBPACK_IMPORTED_MODULE_41__pages_fund_transfer_confirm_fund_transfer_confirm__["a" /* FundTransferConfirmPage */],
                __WEBPACK_IMPORTED_MODULE_42__pages_modal_modal__["a" /* ModalPage */],
                __WEBPACK_IMPORTED_MODULE_44__pages_save_password_save_password__["a" /* SavePasswordPage */],
                __WEBPACK_IMPORTED_MODULE_45__pages_get_otp_get_otp__["a" /* GetOtpPage */],
                __WEBPACK_IMPORTED_MODULE_46__pages_check_password_check_password__["a" /* CheckPasswordPage */],
                __WEBPACK_IMPORTED_MODULE_47__pages_payment_success_payment_success__["a" /* PaymentSuccessPage */],
                __WEBPACK_IMPORTED_MODULE_48__pages_contact_us_contact_us__["a" /* ContactUsPage */]
            ],
            imports: [__WEBPACK_IMPORTED_MODULE_3__angular_http__["a" /* HttpModule */], __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["c" /* HttpClientModule */], __WEBPACK_IMPORTED_MODULE_5__angular_platform_browser_animations__["a" /* BrowserAnimationsModule */],
                ...
                __WEBPACK_IMPORTED_MODULE_23_ionic2_auto_complete__["a" /* AutoCompleteModule */],
                ...
                __WEBPACK_IMPORTED_MODULE_29__angular_router__["b" /* RouterModule */].forRoot(__WEBPACK_IMPORTED_MODULE_30__routes__["a" /* appRoutes */]),
            ],
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_43__pages_auth_auth_guard__["a" /* AuthGuard */], __WEBPACK_IMPORTED_MODULE_6__ionic_native_toast__["a" /* Toast */],
                {
                    provide: __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HTTP_INTERCEPTORS */],
                    useClass: __WEBPACK_IMPORTED_MODULE_28__pages_auth_auth_interceptor__["a" /* AuthInterceptor */],
                    multi: true
                },
                __WEBPACK_IMPORTED_MODULE_26__pages_services_app_data_service__["a" /* RegisterService */],
                __WEBPACK_IMPORTED_MODULE_27__pages_UIHelperClasses_UIHelperService__["a" /* UIHelperService */],
                __WEBPACK_IMPORTED_MODULE_31__pages_services_Storage_Service__["a" /* StorageService */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__banking_banking__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__recharge_recharge__ = __webpack_require__(176);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_Storage_Service__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__recharge_report_recharge_report__ = __webpack_require__(177);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__login_login__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_app_data_service__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__bank_branches_bank_branches__ = __webpack_require__(185);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PagePage = /** @class */ (function () {
    function PagePage(event, alertCtrl, registerService, storageService, viewCtrl, events, navCtrl, navParams) {
        var _this = this;
        this.event = event;
        this.alertCtrl = alertCtrl;
        this.registerService = registerService;
        ...
        this.event.subscribe('REFRESH_isLogOutSetTrueinPage', function () {
            _this.isLogOut = true;
            _this.registerService.isLogOut = true;
        });
    }
    ...
    PagePage.prototype.onLogout = function () {
        var _this = this;
        var alert = this.alertCtrl.create({
            title: "Alert",
            subTitle: 'Are you sure to LogOut?',
            buttons: [
                {
                    ...
                    handler: function () {
                        _this.isLogOut = false;
                        _this.events.publish('REFRESH_isLogOutSetFalse');
                    }
                },
                {
                    text: 'OK',
                    handler: function () {
                        _this.onOK();
                        _this.events.publish('REFRESH_isLogOutSetTrue');
                    }
                }
            ]
        });
    ...
    PagePage.prototype.onOK = function () {
        this.storageService.RemoveRecordsForLogout();
        this.isLogOut = true;
    };
    PagePage.prototype.onLogin = function () {
    ...
    PagePage.prototype.OnBankBranches = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_8__bank_branches_bank_branches__["a" /* BankBranchesPage */]);
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ngx_toastr__ = __webpack_require__(16);
...
var ErrorHandlingService = /** @class */ (function () {
    function ErrorHandlingService(alertCtrl, toastrService) {
        this.alertCtrl = alertCtrl;
        this.toastrService = toastrService;
    }
    ErrorHandlingService.prototype.ErrorHandler = function (controls, ErrorProperties) {
    ...
    ErrorHandlingService = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ngx_toastr__["b" /* ToastrService */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mobile_recharge_mobile_recharge__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__banking_banking__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_app_data_service__ = __webpack_require__(13);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\home\home.html"*/'<div class="row" *ngIf="tenantlist">\n\n  <div class="col s12 m7">\n\n    <div class="card">\n\n        <!--interpolation-->\n\n      <div class="card-content">     \n\n           <div *ngFor="let order of tenantlist" style="border: 1px solid lightgrey; padding: 15px; margin: 5px 0;">\n\n      <span> Id : {{ order.Id |json }}</span> <br>\n\n      <span>Name : {{ order.Name | json }}</span> <br>\n\n      <span>Address : {{ order.Address }}</span> <br>\n\n\n\n    </div> \n\n\n\n      </div>       \n\n    </div>\n\n  </div>\n\n</div>\n\n'/*ion-inline-end:"D:\shailesh_bhat\Angular2Projects\ionic_sahakari\sahakariupdate\src\pages\home\home.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_mobile_recharge_mobile_recharge__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_banking_banking__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_setting_setting__ = __webpack_require__(386);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_services_Storage_Service__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_services_app_data_service__ = __webpack_require__(13);
...
var MyApp = /** @class */ (function () {
    ...
    function MyApp(alertCtrl, translate, storageService, event, platform, statusBar, splashScreen, regService) {
        var _this = this;
        this.alertCtrl = alertCtrl;
        this.translate = translate;
        this.storageService = storageService;
        ...
        platform.ready().then(function () {
            ...
            _this.event.subscribe('REFRESH_isLogOutSetFalse', function () {
                _this.isLogOut = false;
                _this.regService.isLogOut = false;
            });
            _this.event.subscribe('REFRESH_isLogOutSetTrue', function () {
                _this.isLogOut = true;
                _this.regService.isLogOut = true;
            });
            //localStorage.clear();
            _this.event.subscribe('REFRESH_DIGIPARTYNAME', function () {
                ...
                else if (_this.regService.isLogOut == true) {
                    _this.isLogOut = false;
                }
            }); //Above is for refreshing digipartyname
            if (_this.storageService.GetUser() == null) {
                _this.rootPage = __WEBPACK_IMPORTED_MODULE_15__pages_get_otp_get_otp__["a" /* GetOtpPage */];
            }
            else if (__WEBPACK_IMPORTED_MODULE_9__pages_services_Storage_Service__["a" /* StorageService */].GetItem('refreshToken') == null) {
                ...
                _this.showMenuOptions = false; //For loginPage, we need to hide Menu options using this property.
            }
            else {
                _this.rootPage = __WEBPACK_IMPORTED_MODULE_11__pages_page_page__["a" /* PagePage */];
            }
        });
    }
        ...
        var alert = this.alertCtrl.create({
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.onOK();
                        _this.event.publish('REFRESH_isLogOutSetTrueinPage');
                    }
                }
            ]
        });
    ...
    MyApp.prototype.onLogin = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_8__pages_login_login__["a" /* LoginPage */]);
    };
    MyApp.prototype.goToPage = function (params) {
        if (!params)
            params = {};
        this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_11__pages_page_page__["a" /* PagePage */]);
    };
    ...
    MyApp.prototype.goToMyProfile = function (params) {
        if (!params)
            params = {};
        this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_12__pages_my_profile_my_profile__["a" /* MyProfilePage */]);
    };
    MyApp.prototype.goToBankBranches = function (params) {
        if (!params)
            params = {};
        this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_13__pages_bank_branches_bank_branches__["a" /* BankBranchesPage */]);
    };
    MyApp.prototype.goToContactUs = function (params) {
        if (!params)
            params = {};
        this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_16__pages_contact_us_contact_us__["a" /* ContactUsPage */]);
    };
    __decorate([
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ErrorFromServer; });
var ErrorFromServer = /** @class */ (function () {
    function ErrorFromServer() {
    }
    return ErrorFromServer;
}());

//# sourceMappingURL=ErrorFromServer.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_app_data_service__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs__ = __webpack_require__(61);
...
var AuthInterceptor = /** @class */ (function () {
    ...
    AuthInterceptor.prototype.intercept = function (req, next) {
        ...
        if (req.url.indexOf("/token") > 0) {
            var headersforTokenAPI = new __WEBPACK_IMPORTED_MODULE_0__angular_common_http__["e" /* HttpHeaders */]({ 'Content-Type': 'application/x-www-urlencoded' });
            ...
            if (this.refreshToken == null) {
                ...
                this.registerService.GetToken(this.refreshToken).subscribe(function (data) {
                    ...
                    var clonedreq = req.clone({
                        setHeaders: { Authorization: 'Bearer ' + _this.refreshToken }
                    });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pages_register_register__ = __webpack_require__(181);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pages_home_home__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_login_login__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_router__ = __webpack_require__(186);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_auth_auth_guard__ = __webpack_require__(389);
...
var appRoutes = [
    { path: 'home', component: __WEBPACK_IMPORTED_MODULE_1__pages_home_home__["a" /* HomePage */], canActivate: [__WEBPACK_IMPORTED_MODULE_4__pages_auth_auth_guard__["a" /* AuthGuard */]] },
    { path: 'register', component: __WEBPACK_IMPORTED_MODULE_0__pages_register_register__["a" /* RegisterPage */], canActivate: [__WEBPACK_IMPORTED_MODULE_4__pages_auth_auth_guard__["a" /* AuthGuard */]] },
    { path: 'login', component: __WEBPACK_IMPORTED_MODULE_2__pages_login_login__["a" /* LoginPage */], canActivate: [__WEBPACK_IMPORTED_MODULE_4__pages_auth_auth_guard__["a" /* AuthGuard */]] },
];
var routing = __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* RouterModule */].forRoot(appRoutes);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Storage_Service__ = __webpack_require__(11);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
