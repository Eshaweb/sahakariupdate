...
var FundTransferPage = /** @class */ (function () {
    ...
    function FundTransferPage(storageService, alertCtrl, uiService, toastr, loadingController, registerService, formbuilder, navCtrl) {
        ...
        this.formgroup1 = formbuilder.group({
            mobilenum: ['', [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["f" /* Validators */].minLength(10)]]
        });
        ...
        this.formgroup2 = formbuilder.group({
            amount: ['', [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["f" /* Validators */].minLength(1)]]
        });
...
var ModalPage = /** @class */ (function () {
    ...
    ModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-modal',template:/*ion-inline-start:"D:\sahakari\ionic_sahakariWithBugFix\ionic_sahakari\src\pages\modal\modal.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n    <ion-buttons start>\n      <button ion-button (click)="dismiss()">Close</button>\n    </ion-buttons>\n    <ion-title>Reversed Voucher Detail</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <div [hidden]="!myParam">\n    <p>Reversal Transaction ID: {{VendorExtCode}}</p>\n    <p>Amount: {{Amount|currency:\'INR\'}}</p>\n    <p>Date: {{Date|date:\'dd/MM/yyyy\'}}</p>\n    <p>Remarks: {{Remarks}}</p>\n  </div>\n  <div [hidden]="myParam">\n    <p>No parameters passed.</p>\n  </div>\n  <button ion-button color="danger" full (click)="dismiss()">Close</button>\n\n</ion-content>'/*ion-inline-end:"D:\sahakari\ionic_sahakariWithBugFix\ionic_sahakari\src\pages\modal\modal.html"*/,
        }),
...
var SettingPage = /** @class */ (function () {
    ...
    SettingPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-setting',template:/*ion-inline-start:"D:\sahakari\ionic_sahakariWithBugFix\ionic_sahakari\src\pages\setting\setting.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>\n      Setting\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content padding id="page2"></ion-content>'/*ion-inline-end:"D:\sahakari\ionic_sahakariWithBugFix\ionic_sahakari\src\pages\setting\setting.html"*/
        }),
...
var BankBranchesPage = /** @class */ (function () {
    ...
    BankBranchesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-bank-branches',template:/*ion-inline-start:"D:\sahakari\ionic_sahakariWithBugFix\ionic_sahakari\src\pages\bank-branches\bank-branches.html"*/'<!--\n  Generated template for the BankBranchesPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Bank Branches</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n  <div *ngFor="let order of bankBranch" style="background-color:#ddd;border: 1px solid lightgrey; padding: 15px; margin: 5px 0;">\n    <span>{{order.Name}}</span> \n    <br/>\n    <span>{{order.MailName}}</span> \n</div> \n</ion-content>\n'/*ion-inline-end:"D:\sahakari\ionic_sahakariWithBugFix\ionic_sahakari\src\pages\bank-branches\bank-branches.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_Storage_Service__["a" /* StorageService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_4_ngx_toastr__["b" /* ToastrService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_3__services_app_data_service__["a" /* RegisterService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */]])
    ], BankBranchesPage);
...
var MobileRechargePage = /** @class */ (function () {
    function MobileRechargePage(storageService, alertCtrl, uiService, viewCtrl, toastr, constant, registerService, loadingController, navParams, navCtrl, formbuilder) {
        ...
        this.formGroup = formbuilder.group({
            subscriptionId: ['', [__WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].minLength(10)]],
            // operatorId: ['', [Validators.required]],
            // circleId: ['', [Validators.required]],
            operatorId: [''],
            circleId: [''],
            amount: ['', [__WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].required]],
            nickname: ['', [__WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].minLength(2)]]
        });
        var subscriptionIdControl = this.formGroup.get('subscriptionId');
        subscriptionIdControl.valueChanges.subscribe(function (value) { return _this.setErrorMessage(subscriptionIdControl); });
    ...
    MobileRechargePage.prototype.OnNext = function () {
        ...
        if (this.Id == null) {
            ...
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_9__prepaid_confirm_prepaid_confirm__["a" /* PrepaidConfirmPage */], { 'ParentId': this.ParentId, 'Operator': this.operator, 'OperatorId': operatorId.value, 'SubscriptionId': this.rechargeitem.SubscriptionId, 'Amount': this.rechargeitem.Amount });
        }
        else {
...
var LoginPage = /** @class */ (function () {
    function LoginPage(storageService, alertCtrl, uiService, navParams, toastrService, loadingController, formbuilder, registerService, navCtrl) {
        ...
        this.formGroup = formbuilder.group({
            password: ['', [__WEBPACK_IMPORTED_MODULE_5__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_5__angular_forms__["f" /* Validators */].minLength(4)]]
        });
...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"D:\sahakari\ionic_sahakariWithBugFix\ionic_sahakari\src\pages\home\home.html"*/'<div class="row" *ngIf="tenantlist">\n  <div class="col s12 m7">\n    <div class="card">\n        <!--interpolation-->\n      <div class="card-content">     \n           <div *ngFor="let order of tenantlist" style="border: 1px solid lightgrey; padding: 15px; margin: 5px 0;">\n      <span> Id : {{ order.Id |json }}</span> <br>\n      <span>Name : {{ order.Name | json }}</span> <br>\n      <span>Address : {{ order.Address }}</span> <br>\n\n    </div> \n\n      </div>       \n    </div>\n  </div>\n</div>\n'/*ion-inline-end:"D:\sahakari\ionic_sahakariWithBugFix\ionic_sahakari\src\pages\home\home.html"*/
        }),
...
var RegisterPage = /** @class */ (function () {
    function RegisterPage(storageService, alertCtrl, uiService, navParams, loadingController, formbuilder, toastrService, regService, navCtrl) {
        ...
        this.formgroup1 = formbuilder.group({
            mobilenum: ['', [__WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].minLength(10)]]
        });
        ...
        this.formgroup2 = formbuilder.group({
            mobilenumforOTP: ['', [__WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].minLength(10)]]
        });
...
var EnterOTPPage = /** @class */ (function () {
    function EnterOTPPage(storageService, alertCtrl, uiService, toastrService, navParams, loadingController, fb, navCtrl, registerService) {
        ...
        this.ChangePasswordForm = this.fb.group({
            oldPassword: ['', [__WEBPACK_IMPORTED_MODULE_6__angular_forms__["f" /* Validators */].required]],
            newPassword: ['', [__WEBPACK_IMPORTED_MODULE_6__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_6__angular_forms__["f" /* Validators */].minLength(4)]],
            confirmNewpwd: ['', [__WEBPACK_IMPORTED_MODULE_6__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_6__angular_forms__["f" /* Validators */].minLength(4)]]
